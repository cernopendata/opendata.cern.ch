...
|                |                                                                                     |
|----------------|-------------------------------------------------------------------------------------|
| OutputLocation | Phys/B2D0KD02KMuNuWSSUPLine/Particles                                               |
| Postscale      | 1.0000000                                                                           |
| HLT1           | None                                                                                |
...
LoKi::VoidFilter/StrippingB2D0KD02KMuNuWSSUPLineVOIDFilter
...
CombineParticles/B2D0KD02KMuNuWSSUPLine

|                  |                                                                             |
|------------------|-----------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D02KMuNuWS_forB2DXD2HMuNu' , 'Phys/K_forB2DXD2HMuNu' ]            |
...
| Output           | Phys/B2D0KD02KMuNuWSSUPLine/Particles                                       |
