...
|                |                                                                                   |
|----------------|-----------------------------------------------------------------------------------|
| OutputLocation | Phys/b2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemiLine/Particles                    |
| Postscale      | 1.0000000                                                                         |
| HLT1           | None                                                                              |
...
LoKi::VoidFilter/Strippingb2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemiLineVOIDFilter
...
CombineParticles/SelD02KsPiPiPi0ResolvedDDforCharmFromBSemi

|                  |                                                                                                                                                                                          |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelKsDDforCharmFromBSemi' , 'Phys/SelPi0ResolvedforCharmFromBSemi' , 'Phys/SelPilooseforCharmFromBSemi' ]                                                                      |
...
| Output           | Phys/SelD02KsPiPiPi0ResolvedDDforCharmFromBSemi/Particles                                                                                                                                |
...
CombineParticles/SelDstarPiPiPi0ResolvedDDForCharmFromBSemi

|                  |                                                                                                                                         |
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelD02KsPiPiPi0ResolvedDDforCharmFromBSemi' , 'Phys/[StdAllLoosePions](./stripping21r1p1-commonparticles-stdallloosepions)' ] |
...
| Output           | Phys/SelDstarPiPiPi0ResolvedDDForCharmFromBSemi/Particles                                                                               |

CombineParticles/Selb2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemi

|                  |                                                                                                                                                                                                |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelDstarPiPiPi0ResolvedDDForCharmFromBSemi' , 'Phys/SelMuforCharmFromBSemi' ]                                                                                                        |
...
| Output           | Phys/Selb2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemi/Particles                                                                                                                                  |

TisTosParticleTagger/b2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemiLine

|                 |                                                                                                                                       |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Selb2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemi' ]                                                                           |
| DecayDescriptor | None                                                                                                                                  |
| Output          | Phys/b2DstarMuXKsPiPiPi0ResolvedDDCharmFromBSemiLine/Particles                                                                        |
