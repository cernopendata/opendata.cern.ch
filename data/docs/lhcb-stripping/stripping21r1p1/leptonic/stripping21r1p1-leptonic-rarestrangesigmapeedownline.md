...
|      |                                                                                                                       |
|------|-----------------------------------------------------------------------------------------------------------------------|
| Code | CONTAINS('Phys/[StdNoPIDsDownElectrons](./stripping21r1p1-commonparticles-stdnopidsdownelectrons)/Particles',True)\>0 |
...
|                  |                                                                                                                                                                                                                                                                               |
|------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/[StdNoPIDsDownElectrons](./stripping21r1p1-commonparticles-stdnopidsdownelectrons)' , 'Phys/[StdNoPIDsDownProtons](./stripping21r1p1-commonparticles-stdnopidsdownprotons)' ]                                                                                       |
