...
|                |                                           |
|----------------|-------------------------------------------|
| OutputLocation | Phys/B2XuMuNuBs2KSS_FakeKMuLine/Particles |
| Postscale      | 1.0000000                                 |
| HLT1           | None                                      |
| HLT2           | None                                      |
...
LoKi::VoidFilter/StrippingB2XuMuNuBs2KSS_FakeKMuLineVOIDFilter
...
TisTosParticleTagger/B2XuMuNuBs2KSS_FakeKMuLine

|                 |                                                                                      |
|-----------------|--------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KMuSS_NoPIDKmu_forB2XuMuNu' ]                                              |
| DecayDescriptor | None                                                                                 |
| Output          | Phys/B2XuMuNuBs2KSS_FakeKMuLine/Particles                                            |
