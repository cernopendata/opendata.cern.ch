...
|                |                                                        |
|----------------|--------------------------------------------------------|
| OutputLocation | Phys/Bu2DdoubleStar0TauNuForB2XTauNuAllLines/Particles |
| Postscale      | 1.0000000                                              |
| HLT1           | None                                                   |
| HLT2           | None                                                   |
| Prescale       | 1.0000000                                              |
...
CombineParticles/SelBu2DdoubleStar0TauNu
...
| Output           | Phys/SelBu2DdoubleStar0TauNu/Particles                                                                                                                             |

TisTosParticleTagger/Bu2DdoubleStar0TauNuForB2XTauNuAllLines

|                 |                                                        |
|-----------------|--------------------------------------------------------|
| Inputs          | [ 'Phys/SelBu2DdoubleStar0TauNu' ]                   |
| DecayDescriptor | None                                                   |
| Output          | Phys/Bu2DdoubleStar0TauNuForB2XTauNuAllLines/Particles |
