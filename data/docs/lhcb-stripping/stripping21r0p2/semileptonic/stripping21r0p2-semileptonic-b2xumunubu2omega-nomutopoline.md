...
|                |                                              |
|----------------|----------------------------------------------|
| OutputLocation | Phys/B2XuMuNuBu2Omega_NoMuTopoLine/Particles |
| Postscale      | 1.0000000                                    |
| HLT1           | None                                         |
| HLT2           | None                                         |
| Prescale       | 0.10000000                                   |
...
LoKi::VoidFilter/StrippingB2XuMuNuBu2Omega_NoMuTopoLineVOIDFilter
...
CombineParticles/OmegaMuNoMuTopo_forB2XuMuNu
...
| Output           | Phys/OmegaMuNoMuTopo_forB2XuMuNu/Particles                                                                                     |

TisTosParticleTagger/B2XuMuNuBu2Omega_NoMuTopoLine

|                 |                                                                                                                            |
|-----------------|----------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/OmegaMuNoMuTopo_forB2XuMuNu' ]                                                                                   |
| DecayDescriptor | None                                                                                                                       |
| Output          | Phys/B2XuMuNuBu2Omega_NoMuTopoLine/Particles                                                                               |
