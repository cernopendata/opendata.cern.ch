...
|                |                                             |
|----------------|---------------------------------------------|
| OutputLocation | Phys/B2XuMuNuBs2Kstar_NoPIDMuLine/Particles |
| Postscale      | 1.0000000                                   |
| HLT1           | None                                        |
| HLT2           | None                                        |
...
LoKi::VoidFilter/StrippingB2XuMuNuBs2Kstar_NoPIDMuLineVOIDFilter
...
CombineParticles/KstarMuNoPIDmu_forB2XuMuNu

|                  |                                                                                                         |
|------------------|---------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/Kstar_forB2XuMuNu' , 'Phys/MuNoPID_forB2XuMuNu' ]                                             |
...
| Output           | Phys/KstarMuNoPIDmu_forB2XuMuNu/Particles                                                               |

TisTosParticleTagger/B2XuMuNuBs2Kstar_NoPIDMuLine

|                 |                                                                                                                            |
|-----------------|----------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KstarMuNoPIDmu_forB2XuMuNu' ]                                                                                    |
| DecayDescriptor | None                                                                                                                       |
| Output          | Phys/B2XuMuNuBs2Kstar_NoPIDMuLine/Particles                                                                                |
