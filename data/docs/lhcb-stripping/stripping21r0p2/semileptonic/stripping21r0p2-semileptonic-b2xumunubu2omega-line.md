...
|                |                                      |
|----------------|--------------------------------------|
| OutputLocation | Phys/B2XuMuNuBu2Omega_Line/Particles |
| Postscale      | 1.0000000                            |
| HLT1           | None                                 |
| HLT2           | None                                 |
| Prescale       | 1.0000000                            |
...
LoKi::VoidFilter/StrippingB2XuMuNuBu2Omega_LineVOIDFilter
...
CombineParticles/OmegaMu_forB2XuMuNu
...
| Output           | Phys/OmegaMu_forB2XuMuNu/Particles                                                                                             |

TisTosParticleTagger/B2XuMuNuBu2Omega_Line

|                 |                                                                                                                                |
|-----------------|--------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/OmegaMu_forB2XuMuNu' ]                                                                                               |
| DecayDescriptor | None                                                                                                                           |
| Output          | Phys/B2XuMuNuBu2Omega_Line/Particles                                                                                           |
