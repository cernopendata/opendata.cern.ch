...
|                |                                              |
|----------------|----------------------------------------------|
| OutputLocation | Phys/B2XuMuNuBs2Kstar_NoMuTopoLine/Particles |
| Postscale      | 1.0000000                                    |
| HLT1           | None                                         |
| HLT2           | None                                         |
| Prescale       | 0.10000000                                   |
...
LoKi::VoidFilter/StrippingB2XuMuNuBs2Kstar_NoMuTopoLineVOIDFilter
...
CombineParticles/KstarMuNoMuTopo_forB2XuMuNu
...
| Output           | Phys/KstarMuNoMuTopo_forB2XuMuNu/Particles                                                              |

TisTosParticleTagger/B2XuMuNuBs2Kstar_NoMuTopoLine

|                 |                                                                                                                            |
|-----------------|----------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KstarMuNoMuTopo_forB2XuMuNu' ]                                                                                   |
| DecayDescriptor | None                                                                                                                       |
| Output          | Phys/B2XuMuNuBs2Kstar_NoMuTopoLine/Particles                                                                               |
