...
# StrippingB2XuENuBu2Rho_WSLine

## Properties:

|                |                                     |
|----------------|-------------------------------------|
| OutputLocation | Phys/B2XuENuBu2Rho_WSLine/Particles |
| Postscale      | 1.0000000                           |
| HLT1           | None                                |
| HLT2           | None                                |
| Prescale       | 0.20000000                          |
...
LoKi::VoidFilter/StrippingB2XuENuBu2Rho_WSLineVOIDFilter
...
CombineParticles/Rho02PiPiWS_forB2XuENu
...
| Output           | Phys/Rho02PiPiWS_forB2XuENu/Particles                                                                                                                                                                                                                                |

CombineParticles/RhoEWS_forB2XuENu

|                  |                                                                                                                               |
|------------------|-------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/ETightCuts_forB2XuENu' , 'Phys/Rho02PiPiWS_forB2XuENu' ]                                                            |
...
| Output           | Phys/RhoEWS_forB2XuENu/Particles                                                                                              |

TisTosParticleTagger/B2XuENuBu2Rho_WSLine

|                 |                                                                                                                                     |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/RhoEWS_forB2XuENu' ]                                                                                                      |
| DecayDescriptor | None                                                                                                                                |
| Output          | Phys/B2XuENuBu2Rho_WSLine/Particles                                                                                                 |
