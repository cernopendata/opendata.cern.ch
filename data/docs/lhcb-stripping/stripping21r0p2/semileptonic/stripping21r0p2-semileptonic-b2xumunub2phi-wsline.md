...
|                |                                     |
|----------------|-------------------------------------|
| OutputLocation | Phys/B2XuMuNuB2Phi_WSLine/Particles |
| Postscale      | 1.0000000                           |
| HLT1           | None                                |
| HLT2           | None                                |
| Prescale       | 0.20000000                          |
...
LoKi::VoidFilter/StrippingB2XuMuNuB2Phi_WSLineVOIDFilter
...
CombineParticles/PhiKKWS_forB2XuMuNu
...
| Output           | Phys/PhiKKWS_forB2XuMuNu/Particles                                                             |

CombineParticles/PhiMuWS_forB2XuMuNu

|                  |                                                                                              |
|------------------|----------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/MuL0TOS_forB2XuMuNuTOS' , 'Phys/PhiKKWS_forB2XuMuNu' ]                             |
...
| Output           | Phys/PhiMuWS_forB2XuMuNu/Particles                                                           |

TisTosParticleTagger/B2XuMuNuB2Phi_WSLine

|                 |                                                                                                                                |
|-----------------|--------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/PhiMuWS_forB2XuMuNu' ]                                                                                               |
| DecayDescriptor | None                                                                                                                           |
| Output          | Phys/B2XuMuNuB2Phi_WSLine/Particles                                                                                            |
