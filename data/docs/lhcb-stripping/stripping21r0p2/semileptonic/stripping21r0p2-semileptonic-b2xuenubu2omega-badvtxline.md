...
# StrippingB2XuENuBu2Omega_BadVtxLine

## Properties:

|                |                                           |
|----------------|-------------------------------------------|
| OutputLocation | Phys/B2XuENuBu2Omega_BadVtxLine/Particles |
| Postscale      | 1.0000000                                 |
| HLT1           | None                                      |
| HLT2           | None                                      |
| Prescale       | 0.20000000                                |
...
LoKi::VoidFilter/StrippingB2XuENuBu2Omega_BadVtxLineVOIDFilter
...
CombineParticles/OmegaEBadVtx_forB2XuENu
...
| Output           | Phys/OmegaEBadVtx_forB2XuENu/Particles                                                                                         |

TisTosParticleTagger/B2XuENuBu2Omega_BadVtxLine

|                 |                                                                                                                                     |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/OmegaEBadVtx_forB2XuENu' ]                                                                                                |
| DecayDescriptor | None                                                                                                                                |
| Output          | Phys/B2XuENuBu2Omega_BadVtxLine/Particles                                                                                           |
