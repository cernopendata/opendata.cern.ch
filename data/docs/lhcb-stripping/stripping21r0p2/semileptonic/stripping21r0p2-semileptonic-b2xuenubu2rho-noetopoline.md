...
# StrippingB2XuENuBu2Rho_NoETopoLine

## Properties:

|                |                                          |
|----------------|------------------------------------------|
| OutputLocation | Phys/B2XuENuBu2Rho_NoETopoLine/Particles |
| Postscale      | 1.0000000                                |
| HLT1           | None                                     |
| HLT2           | None                                     |
| Prescale       | 0.10000000                               |
...
LoKi::VoidFilter/StrippingB2XuENuBu2Rho_NoETopoLineVOIDFilter
...
CombineParticles/RhoENoETopo_forB2XuENu
...
| Output           | Phys/RhoENoETopo_forB2XuENu/Particles                                                                                          |

TisTosParticleTagger/B2XuENuBu2Rho_NoETopoLine

|                 |                                                                                                                                   |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/RhoENoETopo_forB2XuENu' ]                                                                                               |
| DecayDescriptor | None                                                                                                                              |
| Output          | Phys/B2XuENuBu2Rho_NoETopoLine/Particles                                                                                          |
