...
|                |                               |
|----------------|-------------------------------|
| OutputLocation | Phys/Bu2LLK_eeLine4/Particles |
| Postscale      | 1.0000000                     |
| HLT1           | None                          |
| HLT2           | None                          |
| Prescale       | 1.0000000                     |
...
**LoKi::VoidFilter/StrippingBu2LLK_eeLine4VOIDFilter**
...
**LoKi::VoidFilter/SELECT:Phys/StdLooseDetachedDiElectronLU**

|      |                                                  |
|------|--------------------------------------------------|
| Code | 0 StdLooseDetachedDiElectronLU /Particles',True) |

**FilterDesktop/SelDiElectronLUBu2LLK**

|                 |                                                                                                                                                                                                                                                                                                                                                                                                       |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Code            | (ID=='J/psi(1S)') & (PT \> 0 \*MeV) & (MM \< 5500 \*MeV) & (MINTREE(ABSID\<14,PT) \> 350 \*MeV) & (MINTREE(ABSID\<14,MIPCHI2DV(PRIMARY)) \> 9) & (VFASPF(VCHI2/VDOF) \< 9) & (BPVVDCHI2 \> 16) & (MIPCHI2DV(PRIMARY) \> 0) & ((2 == NINTREE(((TRTYPE==3) & (PIDe \> 0)) \| ((TRTYPE==4) & ((INFO(16,-1000)==1) \| (PPHASRICH & (PPINFO(100,-10000,-10000) \> -5)))) )) & (NINTREE((TRTYPE==4)) == 1)) |
| Inputs          | [ 'Phys/ [StdLooseDetachedDiElectronLU](./stripping21r0p2-stdloosedetacheddielectronlu) ' ]                                                                                                                                                                                                                                                                                                         |
| DecayDescriptor | None                                                                                                                                                                                                                                                                                                                                                                                                  |
| Output          | Phys/SelDiElectronLUBu2LLK/Particles                                                                                                                                                                                                                                                                                                                                                                  |

**GaudiSequencer/MERGED:MergeBu2LLK_ee4**

**Members:**

**GaudiSequencer/MERGEDINPUTS:MergeBu2LLK_ee4**
...
|-----------------|---------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                         |
| Inputs          | [ 'Phys/StdKs2PiPiLL' , 'Phys/ [StdVeryLooseKsLL](./stripping21r0p2-stdverylooseksll) ' ] |
| DecayDescriptor | None                                                                                        |
...
|-----------------|-------------------------------------------------------------------------------------|
| Code            | ALL                                                                                 |
| Inputs          | [ 'Phys/StdKs2PiPiDD' , 'Phys/ [StdLooseKsDD](./stripping21r0p2-stdlooseksdd) ' ] |
| DecayDescriptor | None                                                                                |
...
|-----------------|--------------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                                    |
| Inputs          | [ 'Phys/StdLambda2PPiLL' , 'Phys/ [StdVeryLooseLambdaLL](./stripping21r0p2-stdverylooselambdall) ' ] |
| DecayDescriptor | None                                                                                                   |
...
|-----------------|------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                            |
| Inputs          | [ 'Phys/StdLambda2PPiDD' , 'Phys/ [StdLooseLambdaDD](./stripping21r0p2-stdlooselambdadd) ' ] |
| DecayDescriptor | None                                                                                           |
...
|                  |                                                                                                                                                                                                                                                                                                                  |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/MergedKstarsPlusLLForBu2LLK' , 'Phys/ [StdLoosePions](./stripping21r0p2-stdloosepions) ' ]                                                                                                                                                                                                             |
...
|                  |                                                                                                                                                                                                                                                                                                                  |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/MergedKstarsPlusDDForBu2LLK' , 'Phys/ [StdLoosePions](./stripping21r0p2-stdloosepions) ' ]                                                                                                                                                                                                             |
| DaughtersCuts    | { '' : 'ALL' , 'KS0' : '(PT \> 400 \*MeV) & (M \< 2600\*MeV) & (NDAUGHTERS == NINTREE(ISBASIC & (MIPCHI2DV(PRIMARY) \> 9)))' , 'pi+' : '(PT \> 400 \*MeV) & (M \< 2600\*MeV) & (ISBASIC & (MIPCHI2DV(PRIMARY) \> 9))' , 'pi-' : '(PT \> 400 \*MeV) & (M \< 2600\*MeV) & (ISBASIC & (MIPCHI2DV(PRIMARY) \> 9))' } |
| CombinationCut   | (APT \> 400 \*MeV) & (ADAMASS('K\*(892)+') \< 300 \*MeV) & (ADOCACHI2CUT( 30 , ''))                                                                                                                                                                                                                              |
| MotherCut        | (VFASPF(VCHI2) \< 25)                                                                                                                                                                                                                                                                                            |
| DecayDescriptor  | [K\*(892)+ -\> KS0 pi+]cc                                                                                                                                                                                                                                                                                      |
...
**FilterDesktop/MergeBu2LLK_ee4**

|                 |                                                                                                                                                                                                                                                                                                         |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                                                                                                                                                                                                                                     |
| Inputs          | [ 'Phys/KaonsForBu2LLK' , 'Phys/KshortsDDForBu2LLK' , 'Phys/KshortsLLForBu2LLK' , 'Phys/KstarsForBu2LLK' , 'Phys/KstarsPlusDDForBu2LLK' , 'Phys/KstarsPlusLLForBu2LLK' , 'Phys/LambdasDDForBu2LLK' , 'Phys/LambdasLLForBu2LLK' , 'Phys/PhisForBu2LLK' , 'Phys/PionsForBu2LLK' , 'Phys/pKsForBu2LLK' ] |
| DecayDescriptor | None                                                                                                                                                                                                                                                                                                    |
| Output          | Phys/MergeBu2LLK_ee4/Particles                                                                                                                                                                                                                                                                          |

|                                |                                                                                                           |
|--------------------------------|-----------------------------------------------------------------------------------------------------------|
| StatTableHeader :              | \| Counter \| \# \| sum \| mean/eff^\* \| rms/err^\* \| min \| max \|                                     |
| InputPlotsPath :               | IMergeBu2LLK_ee4                                                                                          |
| Monitor :                      | False                                                                                                     |
| AuditExecute :                 | True                                                                                                      |
| DataOutputs :                  | None                                                                                                      |
| ReFitPVs :                     | False                                                                                                     |
...
| PreloadTools :                 | False                                                                                                     |
| ForceP2PVBuild :               | True                                                                                                      |
| OutputPlotsPath :              | OMergeBu2LLK_ee4                                                                                          |
| NeededResources :              | [ ]                                                                                                     |
| Context :                      | None                                                                                                      |
| OutputLevel :                  | 3                                                                                                         |
| ForceOutput :                  | True                                                                                                      |
...
**CombineParticles/Bu2LLK_eeLine4**

|                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/MergeBu2LLK_ee4' , 'Phys/SelDiElectronLUBu2LLK' ]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Output           | Phys/Bu2LLK_eeLine4/Particles                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |

**AddRelatedInfo/RelatedInfo1_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo1_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo2_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo2_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo3_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo3_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo4_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo4_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo5_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo5_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo6_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo6_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo7_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo7_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo8_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo8_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo9_Bu2LLK_eeLine4**

|                 |                                            |
|-----------------|--------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                |
| DecayDescriptor | None                                       |
| Output          | Phys/RelatedInfo9_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo10_Bu2LLK_eeLine4**

|                 |                                             |
|-----------------|---------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                 |
| DecayDescriptor | None                                        |
| Output          | Phys/RelatedInfo10_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo11_Bu2LLK_eeLine4**

|                 |                                             |
|-----------------|---------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                 |
| DecayDescriptor | None                                        |
| Output          | Phys/RelatedInfo11_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo12_Bu2LLK_eeLine4**

|                 |                                             |
|-----------------|---------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                 |
| DecayDescriptor | None                                        |
| Output          | Phys/RelatedInfo12_Bu2LLK_eeLine4/Particles |

**AddRelatedInfo/RelatedInfo13_Bu2LLK_eeLine4**

|                 |                                             |
|-----------------|---------------------------------------------|
| Inputs          | [ 'Phys/Bu2LLK_eeLine4' ]                 |
| DecayDescriptor | None                                        |
| Output          | Phys/RelatedInfo13_Bu2LLK_eeLine4/Particles |
