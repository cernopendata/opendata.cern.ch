...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/Bc2D0PiD02HHPIDBeauty2CharmLine/Particles                                  |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingBc2D0PiD02HHPIDBeauty2CharmLineVOIDFilter
...
CombineParticles/Bc2D0PiD02HHPIDBeauty2Charm

|                  |                                                                                                                                                                                                                          |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2HHPIDBeauty2CharmFilter' , 'Phys/PiLooseTopoInputsLooseBeauty2CharmFilter' ]                                                                                                                                 |
| DaughtersCuts    | { '' : 'ALL' , 'D0' : 'ALL' , 'D~0' : 'ALL' , 'pi+' : 'ALL' , 'pi-' : 'ALL' }                                                                                                                                            |
| CombinationCut   | (ASUM(SUMTREE(PT,(ISBASIC \| (ID=='gamma')),0.0))\>5000\*MeV) & (AM\<6800\*MeV) & (AM\>5800\*MeV)                                                                                                                        |
| MotherCut        | (VFASPF(VCHI2/VDOF)\<10) & (INTREE( HASTRACK & ISBASIC & (P\>5000\*MeV) & (PT \> 500\*MeV) & (MIPCHI2DV(PRIMARY) \> 10) & (MIPDV(PRIMARY) \> 0.06\*mm))) & (BPVLTIME()\>0.05\*ps) & (BPVIPCHI2()\<25) & (BPVDIRA\>0.999) |
| DecayDescriptor  | None                                                                                                                                                                                                                     |
| DecayDescriptors | [ 'B_c+ -\> D0 pi+' , 'B_c- -\> D0 pi-' ]                                                                                                                                                                              |
| Output           | Phys/Bc2D0PiD02HHPIDBeauty2Charm/Particles                                                                                                                                                                               |

FilterDesktop/Bc2D0PiD02HHPIDBeauty2CharmLine

|                 |                                                |
|-----------------|------------------------------------------------|
| Code            | ALL                                            |
| Inputs          | [ 'Phys/Bc2D0PiD02HHPIDBeauty2Charm' ]       |
| DecayDescriptor | None                                           |
| Output          | Phys/Bc2D0PiD02HHPIDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo1_Bc2D0PiD02HHPIDBeauty2CharmLine

|                 |                                                             |
|-----------------|-------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2D0PiD02HHPIDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                        |
| Output          | Phys/RelatedInfo1_Bc2D0PiD02HHPIDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_Bc2D0PiD02HHPIDBeauty2CharmLine

|                 |                                                             |
|-----------------|-------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2D0PiD02HHPIDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                        |
| Output          | Phys/RelatedInfo2_Bc2D0PiD02HHPIDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_Bc2D0PiD02HHPIDBeauty2CharmLine

|                 |                                                             |
|-----------------|-------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2D0PiD02HHPIDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                        |
| Output          | Phys/RelatedInfo3_Bc2D0PiD02HHPIDBeauty2CharmLine/Particles |
