...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine/Particles     |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingBc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLineVOIDFilter
...
LoKi::VoidFilter/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmCombCutDstarD2K3HPID2D0PiBeauty2Charm

|      |                                                                  |
|------|------------------------------------------------------------------|
| Code | (CONTAINS('Phys/DstarD2K3HPID2D0PiBeauty2Charm/Particles')\<500) |
...
LoKi::VoidFilter/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmCombCutBC2DD-Dst02D0GammaD02KSHH-Beauty2Charm

|      |                                                                          |
|------|--------------------------------------------------------------------------|
| Code | (CONTAINS('Phys/BC2DD-Dst02D0GammaD02KSHH-Beauty2Charm/Particles')\<500) |

CombineParticles/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                         |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/BC2DD-Dst02D0GammaD02KSHH-Beauty2Charm' , 'Phys/DstarD2K3HPID2D0PiBeauty2Charm' ]                                                                                                                                                                                                                                                                                                             |
...
| Output           | Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                 |

TisTosParticleTagger/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmTISTOS

|                 |                                                                                                                                             |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2Charm' ]                                                                       |
| DecayDescriptor | None                                                                                                                                        |
| Output          | Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmTISTOS/Particles                                                               |
| TisTosSpecs     | { 'Hlt2.\*IncPhi.\*Decision%TIS' : 0 , 'Hlt2.\*IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                                                  |
|-----------------|--------------------------------------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                                                  |
| Inputs          | [ 'Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                                             |
| Output          | Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

FilterDesktop/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine

|                 |                                                                                                |
|-----------------|------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                            |
| Inputs          | [ 'Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                                           |
| Output          | Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine

|                 |                                                                                          |
|-----------------|------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                                     |
| Output          | Phys/RelatedInfo1_Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine

|                 |                                                                                          |
|-----------------|------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                                     |
| Output          | Phys/RelatedInfo2_Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine

|                 |                                                                                          |
|-----------------|------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                                     |
| Output          | Phys/RelatedInfo3_Bc2DstDst0Dst2D0PID02KHHHDst02D0GammaD02KSHHBeauty2CharmLine/Particles |
