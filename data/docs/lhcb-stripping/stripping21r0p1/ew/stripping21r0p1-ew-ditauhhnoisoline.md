...
# StrippingDitauHHnoisoLine

## Properties:

|                |                                 |
|----------------|---------------------------------|
| OutputLocation | Phys/DitauHHnoisoLine/Particles |
| Postscale      | 1.0000000                       |
| HLT1           | None                            |
| HLT2           | None                            |
...
GaudiSequencer/SeqDitauHHnoisoLine

GaudiSequencer/SEQ:SelDitauCand_h1h1_os_noiso
...
CombineParticles/SelDitauCand_h1h1_os_noiso
...
| Output           | Phys/SelDitauCand_h1h1_os_noiso/Particles                   |
...
GaudiSequencer/SEQ:SelDitauCand_h3h3_os_noiso
...
CombineParticles/SelDitauCand_h3h3_os_noiso
...
| Output           | Phys/SelDitauCand_h3h3_os_noiso/Particles                   |
...
GaudiSequencer/SEQ:SelDitauCand_h1h3_os_noiso
...
CombineParticles/SelDitauCand_h1h3_os_noiso
...
| Output           | Phys/SelDitauCand_h1h3_os_noiso/Particles                                                |
...
FilterDesktop/DitauHHnoisoLine

|                 |                                                                                                                 |
|-----------------|-----------------------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                                             |
| Inputs          | [ 'Phys/SelDitauCand_h1h1_os_noiso' , 'Phys/SelDitauCand_h1h3_os_noiso' , 'Phys/SelDitauCand_h3h3_os_noiso' ] |
| DecayDescriptor | None                                                                                                            |
| Output          | Phys/DitauHHnoisoLine/Particles                                                                                 |
...
AddRelatedInfo/RelatedInfo1_DitauHHnoisoLine

|                 |                                              |
|-----------------|----------------------------------------------|
| Inputs          | [ 'Phys/DitauHHnoisoLine' ]                |
| DecayDescriptor | None                                         |
| Output          | Phys/RelatedInfo1_DitauHHnoisoLine/Particles |
