...
# StrippingDitauEXnoisoLine

## Properties:

|                |                                 |
|----------------|---------------------------------|
| OutputLocation | Phys/DitauEXnoisoLine/Particles |
| Postscale      | 1.0000000                       |
| HLT1           | None                            |
| HLT2           | None                            |
...
GaudiSequencer/SeqDitauEXnoisoLine

GaudiSequencer/SEQ:SelDitauCand_ee_os_noiso
...
CombineParticles/SelDitauCand_ee_os_noiso
...
| Output           | Phys/SelDitauCand_ee_os_noiso/Particles          |
...
GaudiSequencer/SEQ:SelDitauCand_eh3_os_noiso
...
CombineParticles/SelDitauCand_eh3_os_noiso
...
| Output           | Phys/SelDitauCand_eh3_os_noiso/Particles                                               |
...
GaudiSequencer/SEQ:SelDitauCand_eh1_os_noiso
...
CombineParticles/SelDitauCand_eh1_os_noiso
...
| Output           | Phys/SelDitauCand_eh1_os_noiso/Particles                                             |
...
FilterDesktop/DitauEXnoisoLine

|                 |                                                                                                                                                |
|-----------------|------------------------------------------------------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                                                                            |
| Inputs          | [ 'Phys/SelDitauCand_ee_os_noiso' , 'Phys/SelDitauCand_eh1_os_noiso' , 'Phys/SelDitauCand_eh3_os_noiso' , 'Phys/SelDitauCand_emu_os_noiso' ] |
| DecayDescriptor | None                                                                                                                                           |
| Output          | Phys/DitauEXnoisoLine/Particles                                                                                                                |
...
AddRelatedInfo/RelatedInfo1_DitauEXnoisoLine

|                 |                                              |
|-----------------|----------------------------------------------|
| Inputs          | [ 'Phys/DitauEXnoisoLine' ]                |
| DecayDescriptor | None                                         |
| Output          | Phys/RelatedInfo1_DitauEXnoisoLine/Particles |
