...
|                |                                                                              |
|----------------|------------------------------------------------------------------------------|
| OutputLocation | Phys/B02DKLTUBD2HHHBeauty2CharmLine/Particles                                |
| Postscale      | 1.0000000                                                                    |
| HLT            | (HLT_PASS_RE('Hlt2Topo.\*Decision') \| HLT_PASS_RE('Hlt2IncPhi.\*Decision')) |
| Prescale       | 0.040000000                                                                  |
| L0DU           | None                                                                         |
| ODIN           | None                                                                         |

## Filter sequence:

LoKi::VoidFilter/StrippingB02DKLTUBD2HHHBeauty2CharmLineVOIDFilter
...
FilterDesktop/PromptKaonsTopoInputsBeauty2CharmFilter
...
| DecayDescriptor | None                                                                                |
| Output          | Phys/PromptKaonsTopoInputsBeauty2CharmFilter/Particles                              |

CombineParticles/B02DKLTUBD2HHHBeauty2Charm

|                  |                                                                                                                                                                                                        |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2HHHCFPIDBeauty2CharmFilter' , 'Phys/PromptKaonsTopoInputsBeauty2CharmFilter' ]                                                                                                             |
| DaughtersCuts    | { '' : 'ALL' , 'D+' : 'ALL' , 'D-' : 'ALL' , 'K+' : 'ALL' , 'K-' : 'ALL' }                                                                                                                             |
| CombinationCut   | (ASUM(SUMTREE(PT,(ISBASIC \| (ID=='gamma')),0.0))\>5000\*MeV) & (AM\<7000\*MeV) & (AM\>4750\*MeV)                                                                                                      |
| MotherCut        | (VFASPF(VCHI2/VDOF)\<10) & (NINTREE((ISBASIC & HASTRACK & (TRCHI2DOF\<2.5) & (PT \> 500\*MeV) & (P \> 5000\*MeV))\|((ABSID=='KS0') & (PT \> 500\*MeV) & (P \> 5000\*MeV) & (BPVVDCHI2 \> 1000))) \> 1) |
| DecayDescriptor  | None                                                                                                                                                                                                   |
| DecayDescriptors | [ '[B0 -\> D- K+]cc' ]                                                                                                                                                                             |
| Output           | Phys/B02DKLTUBD2HHHBeauty2Charm/Particles                                                                                                                                                              |

FilterDesktop/B02DKLTUBD2HHHBeauty2CharmLine

|                 |                                               |
|-----------------|-----------------------------------------------|
| Code            | ALL                                           |
| Inputs          | [ 'Phys/B02DKLTUBD2HHHBeauty2Charm' ]       |
| DecayDescriptor | None                                          |
| Output          | Phys/B02DKLTUBD2HHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo1_B02DKLTUBD2HHHBeauty2CharmLine

|                 |                                                            |
|-----------------|------------------------------------------------------------|
| Inputs          | [ 'Phys/B02DKLTUBD2HHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                       |
| Output          | Phys/RelatedInfo1_B02DKLTUBD2HHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_B02DKLTUBD2HHHBeauty2CharmLine

|                 |                                                            |
|-----------------|------------------------------------------------------------|
| Inputs          | [ 'Phys/B02DKLTUBD2HHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                       |
| Output          | Phys/RelatedInfo2_B02DKLTUBD2HHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_B02DKLTUBD2HHHBeauty2CharmLine

|                 |                                                            |
|-----------------|------------------------------------------------------------|
| Inputs          | [ 'Phys/B02DKLTUBD2HHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                       |
| Output          | Phys/RelatedInfo3_B02DKLTUBD2HHHBeauty2CharmLine/Particles |
