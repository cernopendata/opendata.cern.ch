...
|                |                                                                                                |
|----------------|------------------------------------------------------------------------------------------------|
| OutputLocation | Phys/b2DstarMuX3KPiCharmFromBSemiLine/Particles                                                |
| Postscale      | 1.0000000                                                                                      |
...
LoKi::VoidFilter/Strippingb2DstarMuX3KPiCharmFromBSemiLineVOIDFilter
...
CombineParticles/Sel_D0_to_3KPi_forCharmFromBSemi
...
ConjugateNeutralPID/SelConjugateD0ForDstar_3KPiForCharmFromBSemi

|                 |                                                             |
|-----------------|-------------------------------------------------------------|
| Inputs          | [ 'Phys/Sel_D0_to_3KPi_forCharmFromBSemi' ]               |
| DecayDescriptor | None                                                        |
| Output          | Phys/SelConjugateD0ForDstar_3KPiForCharmFromBSemi/Particles |
...
CombineParticles/SelDstar_3KPiForCharmFromBSemi

|                  |                                                                                                                                                                                   |
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelConjugateD0ForDstar_3KPiForCharmFromBSemi' , 'Phys/Sel_D0_to_3KPi_forCharmFromBSemi' , 'Phys/[StdAllLoosePions](./stripping21r1-commonparticles-stdallloosepions)' ] |
...
| Output           | Phys/SelDstar_3KPiForCharmFromBSemi/Particles                                                                                                                                     |

CombineParticles/Selb2DstarMuX3KPiCharmFromBSemi

|                  |                                                                                                                                                                                                |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelDstar_3KPiForCharmFromBSemi' , 'Phys/SelMuforCharmFromBSemi' ]                                                                                                                    |
...
| Output           | Phys/Selb2DstarMuX3KPiCharmFromBSemi/Particles                                                                                                                                                 |

TisTosParticleTagger/b2DstarMuX3KPiCharmFromBSemiLine

|                 |                                                                                                                                                    |
|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Selb2DstarMuX3KPiCharmFromBSemi' ]                                                                                                       |
| DecayDescriptor | None                                                                                                                                               |
| Output          | Phys/b2DstarMuX3KPiCharmFromBSemiLine/Particles                                                                                                    |
