...
# StrippingDstarToHHPi0_Kpipi0_R_Line

## Properties:

|                |                                                        |
|----------------|--------------------------------------------------------|
| OutputLocation | Phys/DstarToHHPi0_Kpipi0_R_Line/Particles              |
| Postscale      | 1.0000000                                              |
...
LoKi::VoidFilter/StrippingDstarToHHPi0_Kpipi0_R_LineVOIDFilter
...
CombineParticles/SelKstDstarToHHPi0_Kpipi0_R\_
...
| Output           | Phys/SelKstDstarToHHPi0_Kpipi0_R\_/Particles                                                                                                                               |
...
CombineParticles/SelD0DstarToHHPi0_Kpipi0_R\_

|                  |                                                                             |
|------------------|-----------------------------------------------------------------------------|
| Inputs           | [ 'Phys/Pi0RForDstarToHHPi0' , 'Phys/SelKstDstarToHHPi0_Kpipi0_R\_' ]     |
...
| Output           | Phys/SelD0DstarToHHPi0_Kpipi0_R\_/Particles                                 |
...
CombineParticles/SelDstDstarToHHPi0_Kpipi0_R\_

|                  |                                                                               |
|------------------|-------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelD0DstarToHHPi0_Kpipi0_R\_' , 'Phys/SlowpionsForDstarToHHPi0' ]   |
| DaughtersCuts    | { '' : 'ALL' , 'D0' : 'ALL' , 'D~0' : 'ALL' , 'pi+' : 'ALL' , 'pi-' : 'ALL' } |
| CombinationCut   | (AM - ACHILD(M,1) \< 180+5 \*MeV) & (ADOCACHI2CUT(20,''))                     |
| MotherCut        | (M - CHILD(M,1) \< 180 \*MeV) & (VFASPF(VCHI2/VDOF) \< 9.0)                   |
| DecayDescriptor  | None                                                                          |
| DecayDescriptors | [ '[D\*(2010)+ -\> D0 pi+]cc' ]                                           |
| Output           | Phys/SelDstDstarToHHPi0_Kpipi0_R\_/Particles                                  |

TisTosParticleTagger/DstarToHHPi0_Kpipi0_R_Line

|                 |                                                 |
|-----------------|-------------------------------------------------|
| Inputs          | [ 'Phys/SelDstDstarToHHPi0_Kpipi0_R\_' ]      |
| DecayDescriptor | None                                            |
| Output          | Phys/DstarToHHPi0_Kpipi0_R_Line/Particles       |
