...
# StrippingB0d2DstarTauNuForB2XTauNu

## Properties:

|                |                                          |
|----------------|------------------------------------------|
| OutputLocation | Phys/B0d2DstarTauNuForB2XTauNu/Particles |
| Postscale      | 1.0000000                                |
| HLT            | None                                     |
| Prescale       | 1.0000000                                |
| L0DU           | None                                     |
...
|                  |                                                                                                                                                                    |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelDstarsForB2XTauNu' , 'Phys/[StdLooseDetachedTau3pi](./stripping21r1-commonparticles-stdloosedetachedtau3pi)' ]                                        |
...
TisTosParticleTagger/B0d2DstarTauNuForB2XTauNu

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/SelB0d2DstarTauNu' ]           |
| DecayDescriptor | None                                     |
| Output          | Phys/B0d2DstarTauNuForB2XTauNu/Particles |
