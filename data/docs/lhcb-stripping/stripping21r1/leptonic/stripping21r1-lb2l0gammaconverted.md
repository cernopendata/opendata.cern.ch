...
|      |                                                                                          |
|------|------------------------------------------------------------------------------------------|
| Code | CONTAINS('Phys/ [StdAllLooseGammaDD](./stripping21r1-stdallloosegammadd) /Particles')\>0 |
...
|      |                                                                                          |
|------|------------------------------------------------------------------------------------------|
| Code | CONTAINS('Phys/ [StdAllLooseGammaLL](./stripping21r1-stdallloosegammall) /Particles')\>0 |
...
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                                                                         |
| Inputs          | [ 'Phys/ [StdAllLooseGammaDD](./stripping21r1-stdallloosegammadd) ' , 'Phys/ [StdAllLooseGammaLL](./stripping21r1-stdallloosegammall) ' ] |
...
| Inputs          | [ 'Phys/ [StdLooseLambdaLL](./stripping21r1-stdlooselambdall) ' ]                                                                                                                                                                                                                                                                                                                                                                                                 |
| DecayDescriptor | None                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| Inputs          | [ 'Phys/ [StdLooseLambdaDD](./stripping21r1-stdlooselambdadd) ' ]                                                                                                                                                                                                                                                                                                                  |
| DecayDescriptor | None                                                                                                                                                                                                                                                                                                                                                                                 |
