...
|                |                                                                                                |
|----------------|------------------------------------------------------------------------------------------------|
| OutputLocation | Phys/b2DpMuXB2DMuNuXLine/Particles                                                             |
| Postscale      | 1.0000000                                                                                      |
...
LoKi::VoidFilter/Strippingb2DpMuXB2DMuNuXLineVOIDFilter
...
CombineParticles/CharmSelForb2DpMuXB2DMuNuX

|                  |                                                                                                                                                                                |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/KforB2DMuNuX' , 'Phys/PiforB2DMuNuX' ]                                                                                                                               |
| DaughtersCuts    | { '' : 'ALL' , 'K+' : 'ALL' , 'K-' : 'ALL' , 'pi+' : 'ALL' , 'pi-' : 'ALL' }                                                                                                   |
| CombinationCut   | (DAMASS('D_s+') \< 90.0 \*MeV) & (DAMASS('D+')\> -90.0 \*MeV)& (ACHILD(PT,1)+ACHILD(PT,2)+ACHILD(PT,3) \> 1800.\*MeV) & (ADOCACHI2CUT( 20, ''))& (ADAMASS('D+') \< 90.0 \*MeV) |
| MotherCut        | (DMASS('D_s+') \< 80.0 \*MeV) & (DMASS('D+')\> -90.0 \*MeV)& (VFASPF(VCHI2/VDOF) \< 6.0) & (BPVVDCHI2 \> 25.0)& (ADMASS('D+') \< 80.0 \*MeV)                                   |
| DecayDescriptor  | None                                                                                                                                                                           |
| DecayDescriptors | [ '[D+ -\> K- pi+ pi+]cc' ]                                                                                                                                                |
| Output           | Phys/CharmSelForb2DpMuXB2DMuNuX/Particles                                                                                                                                      |

CombineParticles/BSelForb2DpMuXB2DMuNuX

|                  |                                                                                                                                                                                             |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/CharmSelForb2DpMuXB2DMuNuX' , 'Phys/MuforB2DMuNuX' ]                                                                                                                              |
...
| Output           | Phys/BSelForb2DpMuXB2DMuNuX/Particles                                                                                                                                                       |

TisTosParticleTagger/b2DpMuXB2DMuNuXLine

|                 |                                                                                                                                                    |
|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/BSelForb2DpMuXB2DMuNuX' ]                                                                                                                |
| DecayDescriptor | None                                                                                                                                               |
| Output          | Phys/b2DpMuXB2DMuNuXLine/Particles                                                                                                                 |
