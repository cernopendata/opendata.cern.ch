...
# StrippingKshort2Leptons2mu2piUVLFV1Line

## Properties:

|                |                                               |
|----------------|-----------------------------------------------|
| OutputLocation | Phys/Kshort2Leptons2mu2piUVLFV1Line/Particles |
| Postscale      | 1.0000000                                     |
| HLT1           | None                                          |
| HLT2           | None                                          |
| Prescale       | 1.0000000                                     |
...
| Inputs          | [ 'Phys/[StdNoPIDsUpPions](./stripping21r1p2-commonparticles-stdnopidsuppions)' ] |
| DecayDescriptor | None                                                                                |
...
CombineParticles/Kshort2Leptons2mu2piUVLFV1Line

|                  |                                                                                                                                                                                                                                      |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/Kshort2LeptonsMuonsL' , 'Phys/Kshort2LeptonsPionsU' , 'Phys/Kshort2LeptonsPionsV' ]                                                                                                                                        |
| DaughtersCuts    | { '' : 'ALL' , 'mu+' : 'ALL' , 'mu-' : 'ALL' , 'pi+' : 'ALL' , 'pi-' : 'ALL' }                                                                                                                                                       |
| CombinationCut   | (AM \< 878.0 \*MeV) & (AMAXDOCA('') \< 0.8 \*mm) & ( ( ANUM( ( TRTYPE == 3 ) & ( ABSID == 'mu+' ) ) == 2 ) ) & ( ( ANUM( ( TRTYPE == 4 ) & ( ABSID == 'pi-' ) ) == 1 ) ) & ( ( ANUM( ( TRTYPE == 1 ) & ( ABSID == 'pi-' ) ) == 1 ) ) |
...
| Output           | Phys/Kshort2Leptons2mu2piUVLFV1Line/Particles                                                                                                                                                                                        |
