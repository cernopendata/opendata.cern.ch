...
# StrippingD2hhPromptDst2D2KKSSLine

## Properties:

|                |                                         |
|----------------|-----------------------------------------|
| OutputLocation | Phys/D2hhPromptDst2D2KKSSLine/Particles |
| Postscale      | 1.0000000                               |
| HLT1           | None                                    |
| HLT2           | None                                    |
| Prescale       | 1.0000000                               |
...
CombineParticles/D2hhPromptD2KKSSSel
...
| Output           | Phys/D2hhPromptD2KKSSSel/Particles                                                                                                                                                                                                                                                                                                                                                                                                     |
...
CombineParticles/D2hhPromptDst2D2KKSSLine

|                  |                                                                                                                    |
|------------------|--------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2hhPromptD2KKSSSel' , 'Phys/[StdAllNoPIDsPions](./stripping21r1p2-commonparticles-stdallnopidspions)' ] |
...
| Output           | Phys/D2hhPromptDst2D2KKSSLine/Particles                                                                            |
