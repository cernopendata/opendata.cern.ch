...
# StrippingK23PiForDownstreamTrackEff_K2PiPiDipionSSNarrow_Long_Line

## Properties:

|                |                                                                          |
|----------------|--------------------------------------------------------------------------|
| OutputLocation | Phys/K23PiForDownstreamTrackEff_K2PiPiDipionSSNarrow_Long_Line/Particles |
| Postscale      | 1.0000000                                                                |
| HLT1           | None                                                                     |
| HLT2           | None                                                                     |
| Prescale       | 0.20000000                                                               |
...
CombineParticles/K23PiForDownstreamTrackEff_K2PiPiDipionSSNarrow_Long_Line
...
| Output           | Phys/K23PiForDownstreamTrackEff_K2PiPiDipionSSNarrow_Long_Line/Particles                                                                                                                                                                                                                           |
