...
|                |                                               |
|----------------|-----------------------------------------------|
| OutputLocation | Phys/OmegabDecaysOmegacpipipiWSLine/Particles |
| Postscale      | 1.0000000                                     |
| HLT1           | None                                          |
| HLT2           | None                                          |
| Prescale       | 1.0000000                                     |
...
CombineParticles/OmegabDecaysOmegacpipipiWSLine

|                  |                                                                                                                                                                                                                         |
|------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/OmegacForOmegabDecays' , 'Phys/[StdLooseANNPions](./stripping21r1p2-commonparticles-stdlooseannpions)' ]                                                                                                      |
...
| DecayDescriptors | [ '[Omega_b- -\> Omega_c0 pi+ pi- pi+]cc' ]                                                                                                                                                                         |
| Output           | Phys/OmegabDecaysOmegacpipipiWSLine/Particles                                                                                                                                                                           |
