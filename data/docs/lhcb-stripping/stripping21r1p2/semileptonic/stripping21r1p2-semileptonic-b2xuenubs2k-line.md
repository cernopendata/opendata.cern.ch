...
# StrippingB2XuENuBs2K_Line

## Properties:

|                |                                 |
|----------------|---------------------------------|
| OutputLocation | Phys/B2XuENuBs2K_Line/Particles |
| Postscale      | 1.0000000                       |
| HLT1           | None                            |
| HLT2           | None                            |
| Prescale       | 1.0000000                       |
...
LoKi::VoidFilter/StrippingB2XuENuBs2K_LineVOIDFilter
...
CombineParticles/KE_forB2XuENu
...
| Output           | Phys/KE_forB2XuENu/Particles                                                                                                  |

TisTosParticleTagger/B2XuENuBs2K_Line

|                 |                                                                                            |
|-----------------|--------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KE_forB2XuENu' ]                                                                 |
| DecayDescriptor | None                                                                                       |
| Output          | Phys/B2XuENuBs2K_Line/Particles                                                            |
