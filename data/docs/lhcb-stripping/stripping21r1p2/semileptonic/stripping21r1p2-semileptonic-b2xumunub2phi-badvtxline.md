...
# StrippingB2XuMuNuB2Phi_BadVtxLine

## Properties:

|                |                                         |
|----------------|-----------------------------------------|
| OutputLocation | Phys/B2XuMuNuB2Phi_BadVtxLine/Particles |
| Postscale      | 1.0000000                               |
| HLT1           | None                                    |
| HLT2           | None                                    |
| Prescale       | 0.10000000                              |
...
LoKi::VoidFilter/StrippingB2XuMuNuB2Phi_BadVtxLineVOIDFilter
...
CombineParticles/PhiMuBadVtx_forB2XuMuNu
...
| Output           | Phys/PhiMuBadVtx_forB2XuMuNu/Particles                                                       |

TisTosParticleTagger/B2XuMuNuB2Phi_BadVtxLine

|                 |                                                                                                                                |
|-----------------|--------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/PhiMuBadVtx_forB2XuMuNu' ]                                                                                           |
| DecayDescriptor | None                                                                                                                           |
| Output          | Phys/B2XuMuNuB2Phi_BadVtxLine/Particles                                                                                        |
