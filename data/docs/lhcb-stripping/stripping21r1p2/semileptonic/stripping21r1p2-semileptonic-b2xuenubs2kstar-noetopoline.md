...
# StrippingB2XuENuBs2Kstar_NoETopoLine

## Properties:

|                |                                            |
|----------------|--------------------------------------------|
| OutputLocation | Phys/B2XuENuBs2Kstar_NoETopoLine/Particles |
| Postscale      | 1.0000000                                  |
| HLT1           | None                                       |
| HLT2           | None                                       |
| Prescale       | 0.10000000                                 |
...
LoKi::VoidFilter/StrippingB2XuENuBs2Kstar_NoETopoLineVOIDFilter
...
CombineParticles/KstarENoETopo_forB2XuENu
...
| Output           | Phys/KstarENoETopo_forB2XuENu/Particles                                                                 |

TisTosParticleTagger/B2XuENuBs2Kstar_NoETopoLine

|                 |                                                                                                                                   |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KstarENoETopo_forB2XuENu' ]                                                                                             |
| DecayDescriptor | None                                                                                                                              |
| Output          | Phys/B2XuENuBs2Kstar_NoETopoLine/Particles                                                                                        |
