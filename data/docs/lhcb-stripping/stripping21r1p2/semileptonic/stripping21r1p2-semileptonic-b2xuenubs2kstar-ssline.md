...
# StrippingB2XuENuBs2Kstar_SSLine

## Properties:

|                |                                       |
|----------------|---------------------------------------|
| OutputLocation | Phys/B2XuENuBs2Kstar_SSLine/Particles |
| Postscale      | 1.0000000                             |
| HLT1           | None                                  |
| HLT2           | None                                  |
| Prescale       | 0.30000000                            |
...
LoKi::VoidFilter/StrippingB2XuENuBs2Kstar_SSLineVOIDFilter
...
CombineParticles/KstarESS_forB2XuENu
...
| Output           | Phys/KstarESS_forB2XuENu/Particles                                                                      |

TisTosParticleTagger/B2XuENuBs2Kstar_SSLine

|                 |                                                                                                                                     |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KstarESS_forB2XuENu' ]                                                                                                    |
| DecayDescriptor | None                                                                                                                                |
| Output          | Phys/B2XuENuBs2Kstar_SSLine/Particles                                                                                               |
