...
- If you want to "re-discover" the **Higgs boson** in the CMS Open Data from 2011-2012, first install the Virtual Machine (VM) as instructed in ["CMS 2011 Virtual Machines: How to install"](/docs/cms-2011-virtual-machines-how-to-install) and look at [this Higgs analysis example](/record/FIXME).
