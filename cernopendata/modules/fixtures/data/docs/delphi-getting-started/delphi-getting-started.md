...
* /cvmfs/delphi.cern.ch mounted
* /eos/opendata/delphi (or /eos/experiments/delphi) mounted
...
## Documentation
DELPHI manuals and notes are available from [https://cds.cern.ch/](http://cds.cern.ch/search?ln=en&p=&action_search=Search&op1=a&m1=a&p1=&f1=&c=DELPHI&sf=&so=d&rm=&rg=10&sc=1&of=hb)
