...
# StrippingB2XTauMu_K\_WSLine

## Properties:

|                |                                   |
|----------------|-----------------------------------|
| OutputLocation | Phys/B2XTauMu_K\_WSLine/Particles |
| Postscale      | 1.0000000                         |
| HLT1           | None                              |
| HLT2           | None                              |
| Prescale       | 0.50000000                        |
...
**GaudiSequencer/SeqB2XTauMu_K\_WS_daughters**
...
**FilterDesktop/B2XTauMu_K\_WS_daughters**
...
| DecayDescriptor | None                                                    |
| Output          | Phys/B2XTauMu_K\_WS_daughters/Particles                 |

|                                |                                                                                                           |
|--------------------------------|-----------------------------------------------------------------------------------------------------------|
| StatTableHeader :              | \| Counter \| \# \| sum \| mean/eff^\* \| rms/err^\* \| min \| max \|                                     |
| InputPlotsPath :               | IB2XTauMu_K\_WS_daughters                                                                                 |
| Monitor :                      | False                                                                                                     |
| AuditExecute :                 | True                                                                                                      |
| DataOutputs :                  | None                                                                                                      |
| ReFitPVs :                     | False                                                                                                     |
...
| PreloadTools :                 | False                                                                                                     |
| ForceP2PVBuild :               | True                                                                                                      |
| OutputPlotsPath :              | OB2XTauMu_K\_WS_daughters                                                                                 |
| NeededResources :              | [ ]                                                                                                     |
| Context :                      | None                                                                                                      |
| OutputLevel :                  | 3                                                                                                         |
| ForceOutput :                  | True                                                                                                      |
...
**CombineParticles/B2XTauMu_K\_WSLine**

|                  |                                                                                                                                                                                                                                                                                                                              |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/B2XTauMu_K\_WS_daughters' , 'Phys/MuforB2XTauMu' ]                                                                                                                                                                                                                                                                 |
...
| Output           | Phys/B2XTauMu_K\_WSLine/Particles                                                                                                                                                                                                                                                                                            |

**AddRelatedInfo/RelatedInfo1_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo1_B2XTauMu_K\_WSLine/Particles |

**AddRelatedInfo/RelatedInfo2_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo2_B2XTauMu_K\_WSLine/Particles |

**AddRelatedInfo/RelatedInfo3_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo3_B2XTauMu_K\_WSLine/Particles |

**AddRelatedInfo/RelatedInfo4_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo4_B2XTauMu_K\_WSLine/Particles |

**AddRelatedInfo/RelatedInfo5_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo5_B2XTauMu_K\_WSLine/Particles |

**AddRelatedInfo/RelatedInfo6_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo6_B2XTauMu_K\_WSLine/Particles |

**AddRelatedInfo/RelatedInfo7_B2XTauMu_K\_WSLine**

|                 |                                                |
|-----------------|------------------------------------------------|
| Inputs          | [ 'Phys/B2XTauMu_K\_WSLine' ]                |
| DecayDescriptor | None                                           |
| Output          | Phys/RelatedInfo7_B2XTauMu_K\_WSLine/Particles |
