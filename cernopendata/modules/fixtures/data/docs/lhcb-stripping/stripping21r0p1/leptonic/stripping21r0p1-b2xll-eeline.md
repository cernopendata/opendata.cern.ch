...
# StrippingB2XLL_eeLine

## Properties:

|                |                             |
|----------------|-----------------------------|
| OutputLocation | Phys/B2XLL_eeLine/Particles |
| Postscale      | 1.0000000                   |
| HLT1           | None                        |
| HLT2           | None                        |
| Prescale       | 1.0000000                   |
...
**LoKi::VoidFilter/StrippingB2XLL_eeLineVOIDFilter**
...
| Output           | Phys/EEForB2XLL/Particles                                                                                                                                                                                                                                              |

**FilterDesktop/SelEEForB2XLL**
...
| Inputs          | [ 'Phys/EEForB2XLL' ]                                                                                                                                                                                              |
| DecayDescriptor | None                                                                                                                                                                                                                 |
| Output          | Phys/SelEEForB2XLL/Particles                                                                                                                                                                                         |

**GaudiSequencer/SeqMergeB2XLL_ee**
...
| DecayDescriptor | None                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Output          | Phys/MergeB2XLL_ee/Particles                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

|                                |                                                                                                           |
|--------------------------------|-----------------------------------------------------------------------------------------------------------|
| StatTableHeader :              | \| Counter \| \# \| sum \| mean/eff^\* \| rms/err^\* \| min \| max \|                                     |
| InputPlotsPath :               | IMergeB2XLL_ee                                                                                            |
| Monitor :                      | False                                                                                                     |
| AuditExecute :                 | True                                                                                                      |
| DataOutputs :                  | None                                                                                                      |
| ReFitPVs :                     | False                                                                                                     |
...
| PreloadTools :                 | False                                                                                                     |
| ForceP2PVBuild :               | True                                                                                                      |
| OutputPlotsPath :              | OMergeB2XLL_ee                                                                                            |
| NeededResources :              | [ ]                                                                                                     |
| Context :                      | None                                                                                                      |
| OutputLevel :                  | 3                                                                                                         |
| ForceOutput :                  | True                                                                                                      |
...
**CombineParticles/B2XLL_eeLine**

|                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/MergeB2XLL_ee' , 'Phys/SelEEForB2XLL' ]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| Output           | Phys/B2XLL_eeLine/Particles                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |

**AddRelatedInfo/RelatedInfo1_B2XLL_eeLine**

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/B2XLL_eeLine' ]                |
| DecayDescriptor | None                                     |
| Output          | Phys/RelatedInfo1_B2XLL_eeLine/Particles |

**AddRelatedInfo/RelatedInfo2_B2XLL_eeLine**

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/B2XLL_eeLine' ]                |
| DecayDescriptor | None                                     |
| Output          | Phys/RelatedInfo2_B2XLL_eeLine/Particles |

**AddRelatedInfo/RelatedInfo3_B2XLL_eeLine**

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/B2XLL_eeLine' ]                |
| DecayDescriptor | None                                     |
| Output          | Phys/RelatedInfo3_B2XLL_eeLine/Particles |

**AddRelatedInfo/RelatedInfo4_B2XLL_eeLine**

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/B2XLL_eeLine' ]                |
| DecayDescriptor | None                                     |
| Output          | Phys/RelatedInfo4_B2XLL_eeLine/Particles |

**AddRelatedInfo/RelatedInfo5_B2XLL_eeLine**

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/B2XLL_eeLine' ]                |
| DecayDescriptor | None                                     |
| Output          | Phys/RelatedInfo5_B2XLL_eeLine/Particles |

**AddRelatedInfo/RelatedInfo6_B2XLL_eeLine**

|                 |                                          |
|-----------------|------------------------------------------|
| Inputs          | [ 'Phys/B2XLL_eeLine' ]                |
| DecayDescriptor | None                                     |
| Output          | Phys/RelatedInfo6_B2XLL_eeLine/Particles |
