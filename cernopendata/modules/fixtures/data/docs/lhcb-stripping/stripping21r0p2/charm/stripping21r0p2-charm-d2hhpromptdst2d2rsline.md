...
|                |                                       |
|----------------|---------------------------------------|
| OutputLocation | Phys/D2hhPromptDst2D2RSLine/Particles |
| Postscale      | 1.0000000                             |
| HLT1           | None                                  |
| HLT2           | None                                  |
| Prescale       | 1.0000000                             |
...
CombineParticles/D2hhPromptD2KPiSel
...
| Output           | Phys/D2hhPromptD2KPiSel/Particles                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

CombineParticles/D2hhPromptDst2D2RSLine

|                  |                                                                                                                   |
|------------------|-------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2hhPromptD2KPiSel' , 'Phys/[StdAllNoPIDsPions](./stripping21r0p2-commonparticles-stdallnopidspions)' ] |
...
| Output           | Phys/D2hhPromptDst2D2RSLine/Particles                                                                             |
