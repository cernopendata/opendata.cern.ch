...
# StrippingB2XuENuBs2K_NoPIDKELine

## Properties:

|                |                                        |
|----------------|----------------------------------------|
| OutputLocation | Phys/B2XuENuBs2K_NoPIDKELine/Particles |
| Postscale      | 1.0000000                              |
| HLT1           | None                                   |
| HLT2           | None                                   |
...
LoKi::VoidFilter/StrippingB2XuENuBs2K_NoPIDKELineVOIDFilter
...
CombineParticles/KE_NoPIDKe_forB2XuENu
...
| Output           | Phys/KE_NoPIDKe_forB2XuENu/Particles                                                                                          |

TisTosParticleTagger/B2XuENuBs2K_NoPIDKELine

|                 |                                                                                           |
|-----------------|-------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KE_NoPIDKe_forB2XuENu' ]                                                        |
| DecayDescriptor | None                                                                                      |
| Output          | Phys/B2XuENuBs2K_NoPIDKELine/Particles                                                    |
