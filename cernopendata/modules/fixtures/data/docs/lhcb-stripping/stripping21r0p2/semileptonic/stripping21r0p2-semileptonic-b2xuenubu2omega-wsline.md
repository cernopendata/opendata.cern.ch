...
# StrippingB2XuENuBu2Omega_WSLine

## Properties:

|                |                                       |
|----------------|---------------------------------------|
| OutputLocation | Phys/B2XuENuBu2Omega_WSLine/Particles |
| Postscale      | 1.0000000                             |
| HLT1           | None                                  |
| HLT2           | None                                  |
| Prescale       | 0.30000000                            |
...
LoKi::VoidFilter/StrippingB2XuENuBu2Omega_WSLineVOIDFilter
...
DaVinci::N3BodyDecays/Omega2PiPiPi0WS_forB2XuENu
...
| Output           | Phys/Omega2PiPiPi0WS_forB2XuENu/Particles                                                                                                                                                                                                             |

CombineParticles/OmegaEWS_forB2XuENu

|                  |                                                                                                                               |
|------------------|-------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/ETightCuts_forB2XuENu' , 'Phys/Omega2PiPiPi0WS_forB2XuENu' ]                                                        |
...
| Output           | Phys/OmegaEWS_forB2XuENu/Particles                                                                                            |

TisTosParticleTagger/B2XuENuBu2Omega_WSLine

|                 |                                                                                                                                     |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/OmegaEWS_forB2XuENu' ]                                                                                                    |
| DecayDescriptor | None                                                                                                                                |
| Output          | Phys/B2XuENuBu2Omega_WSLine/Particles                                                                                               |
