...
|                |                                     |
|----------------|-------------------------------------|
| OutputLocation | Phys/B2DMuNuX_Dp_Electron/Particles |
| Postscale      | 1.0000000                           |
...
LoKi::VoidFilter/StrippingB2DMuNuX_Dp_ElectronVOIDFilter
...
CombineParticles/CharmSelForDp_ElectronB2DMuNuX
...
| Output           | Phys/CharmSelForDp_ElectronB2DMuNuX/Particles                                                                          |

CombineParticles/B2DMuNuX_Dp_Electron

|                  |                                                                                                                                                                                                                                      |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/CharmSelForDp_ElectronB2DMuNuX' , 'Phys/eforB2DMuNuX' ]                                                                                                                                                                    |
...
| Output           | Phys/B2DMuNuX_Dp_Electron/Particles                                                                                                                                                                                                  |
