...
CombineParticles/BSelFakeForD0B2DMuNuX
...
| Output           | Phys/BSelFakeForD0B2DMuNuX/Particles                                                                                                                                                                                                 |

TisTosParticleTagger/B2DMuNuX_D0_FakeMuon

|                 |                                                                                                                                    |
|-----------------|------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/BSelFakeForD0B2DMuNuX' ]                                                                                                 |
| DecayDescriptor | None                                                                                                                               |
