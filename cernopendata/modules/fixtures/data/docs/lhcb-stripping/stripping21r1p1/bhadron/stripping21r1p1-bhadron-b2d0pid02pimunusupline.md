...
|                |                                                                                     |
|----------------|-------------------------------------------------------------------------------------|
| OutputLocation | Phys/B2D0PiD02PiMuNuSUPLine/Particles                                               |
| Postscale      | 1.0000000                                                                           |
| HLT1           | None                                                                                |
...
LoKi::VoidFilter/StrippingB2D0PiD02PiMuNuSUPLineVOIDFilter
...
CombineParticles/B2D0PiD02PiMuNuSUPLine

|                  |                                                                               |
|------------------|-------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D02PiMuNu_forB2DXD2HMuNu' , 'Phys/Pi_forB2DXD2HMuNu' ]              |
| DaughtersCuts    | { '' : 'ALL' , 'D0' : 'ALL' , 'D~0' : 'ALL' , 'pi+' : 'ALL' , 'pi-' : 'ALL' } |
| CombinationCut   | (AM\<5200 \*MeV)                                                              |
| MotherCut        | (MDNDOCA(5.279,0) \< 0.02\*mm) & (lim_up\<0) & (lim_lo\>0)                    |
| DecayDescriptor  | None                                                                          |
| DecayDescriptors | [ '[B+ -\> D0 pi+]cc' ]                                                   |
| Output           | Phys/B2D0PiD02PiMuNuSUPLine/Particles                                         |
