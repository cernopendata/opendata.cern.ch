...
|                |                                                                                   |
|----------------|-----------------------------------------------------------------------------------|
| OutputLocation | Phys/b2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemiLine/Particles                       |
| Postscale      | 1.0000000                                                                         |
| HLT1           | None                                                                              |
...
LoKi::VoidFilter/Strippingb2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemiLineVOIDFilter
...
CombineParticles/Selb2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemi

|                  |                                                                                                                                                                                                |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelD02KsPiPiPi0ResolvedDDforCharmFromBSemi' , 'Phys/SelMuforCharmFromBSemi' ]                                                                                                        |
| DaughtersCuts    | { '' : 'ALL' , 'D0' : 'ALL' , 'D~0' : 'ALL' , 'mu+' : 'ALL' , 'mu-' : 'ALL' }                                                                                                                  |
| CombinationCut   | (AM\<6200\*MeV)                                                                                                                                                                                |
| MotherCut        | (MM\> 2500 \*MeV) & (MM\<6000 \*MeV) & (VFASPF(VCHI2/VDOF)\< 6.0) & (BPVDIRA\> 0.999) & (MINTREE(((ABSID=='D+') \| (ABSID=='D0') \| (ABSID=='Lambda_c+')) , VFASPF(VZ))-VFASPF(VZ) \> 0 \*mm ) |
| DecayDescriptor  | None                                                                                                                                                                                           |
| DecayDescriptors | [ '[B- -\> D0 mu-]cc' ]                                                                                                                                                                    |
| Output           | Phys/Selb2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemi/Particles                                                                                                                                     |

TisTosParticleTagger/b2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemiLine

|                 |                                                                                                                                       |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Selb2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemi' ]                                                                              |
| DecayDescriptor | None                                                                                                                                  |
| Output          | Phys/b2D0MuXKsPiPiPi0ResolvedDDCharmFromBSemiLine/Particles                                                                           |
