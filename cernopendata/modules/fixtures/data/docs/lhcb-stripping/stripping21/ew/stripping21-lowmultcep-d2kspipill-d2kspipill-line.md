...
|                |                                                        |
|----------------|--------------------------------------------------------|
| OutputLocation | Phys/LowMultCEP_D2KsPiPiLL_D2KsPiPiLL_line/Particles   |
| Postscale      | 1.0000000                                              |
...
**LoKi::VoidFilter/StrippingLowMultCEP_D2KsPiPiLL_D2KsPiPiLL_lineVOIDFilter**
...
**CombineParticles/LowMultCEP_D2KsPiPiLL_D2KsPiPiLL_line**

|                  |                                                             |
|------------------|-------------------------------------------------------------|
| Inputs           | [ 'Phys/selD2KsPiPiLL' ]                                  |
| DaughtersCuts    | { '' : 'ALL' , 'D0' : 'ALL' , 'D\~0' : 'ALL' }              |
| CombinationCut   | AALL                                                        |
| MotherCut        | ALL                                                         |
| DecayDescriptor  | None                                                        |
| DecayDescriptors | [ 'psi(3770) -\> D0 D\~0' , '[psi(3770) -\> D0 D0]cc' ] |
| Output           | Phys/LowMultCEP_D2KsPiPiLL_D2KsPiPiLL_line/Particles        |
