...
|                |                                                                              |
|----------------|------------------------------------------------------------------------------|
| OutputLocation | Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine/Particles                  |
| Postscale      | 1.0000000                                                                    |
...
LoKi::VoidFilter/StrippingDstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLineVOIDFilter
...
CombineParticles/B2D0PiPi0MergedD2K3PiBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                          |
|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2K3PIPIDBeauty2CharmFilter' , 'Phys/Pi0FromBMergedBeauty2CharmFilter' , 'Phys/PiTopoInputsBeauty2CharmFilter' ]                                                                                                                                                                                                                                                                               |
...
| Output           | Phys/B2D0PiPi0MergedD2K3PiBeauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                                         |

TisTosParticleTagger/B2D0PiPi0MergedD2K3PiBeauty2CharmTISTOS

|                 |                                                                                                                                       |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B2D0PiPi0MergedD2K3PiBeauty2Charm' ]                                                                                        |
| DecayDescriptor | None                                                                                                                                  |
| Output          | Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmTISTOS/Particles                                                                                |
| TisTosSpecs     | { 'Hlt2IncPhi.\*Decision%TIS' : 0 , 'Hlt2IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                           |
|-----------------|---------------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                           |
| Inputs          | [ 'Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                      |
| Output          | Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

SubstitutePID/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPSel

|                 |                                                                                     |
|-----------------|-------------------------------------------------------------------------------------|
| Code            | DECTREE('Beauty -\> Charm ...')                                                     |
| Inputs          | [ 'Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilter' ]             |
| DecayDescriptor | None                                                                                |
| Output          | Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPSel/Particles |
| Substitutions   | { 'Beauty -\> Charm ...' : 'J/psi(1S)' }                                            |

FilterDesktop/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPFilterBeauty2CharmFilter

|                 |                                                                                                          |
|-----------------|----------------------------------------------------------------------------------------------------------|
| Code            | INTREE(ID=='J/psi(1S)')                                                                                  |
| Inputs          | [ 'Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPSel' ]                        |
| DecayDescriptor | None                                                                                                     |
| Output          | Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPFilterBeauty2CharmFilter/Particles |

CombineParticles/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilter

|                  |                                                                                                                                                               |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/B2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPFilterBeauty2CharmFilter' , 'Phys/PiUPInputsBeauty2CharmFilter' ]                  |
...
| Output           | Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles                                                                              |

FilterDesktop/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine

|                 |                                                                                |
|-----------------|--------------------------------------------------------------------------------|
| Code            | ALL                                                                            |
| Inputs          | [ 'Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                           |
| Output          | Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine

|                 |                                                                          |
|-----------------|--------------------------------------------------------------------------|
| Inputs          | [ 'Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                     |
| Output          | Phys/RelatedInfo1_DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine

|                 |                                                                          |
|-----------------|--------------------------------------------------------------------------|
| Inputs          | [ 'Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                     |
| Output          | Phys/RelatedInfo2_DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine

|                 |                                                                          |
|-----------------|--------------------------------------------------------------------------|
| Inputs          | [ 'Phys/DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                     |
| Output          | Phys/RelatedInfo3_DstarUPB2D0PiPi0MergedD2K3PiBeauty2CharmLine/Particles |
