...
|                |                                                                              |
|----------------|------------------------------------------------------------------------------|
| OutputLocation | Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine/Particles                      |
| Postscale      | 1.0000000                                                                    |
...
LoKi::VoidFilter/StrippingDstarUPB2DKstar0D2HHHPIDBeauty2CharmLineVOIDFilter
...
FilterDesktop/K\*0Beauty2CharmFilter

|                 |                                       |
|-----------------|---------------------------------------|
| Code            | ADMASS('K\*(892)0') \< 150\*MeV       |
| Inputs          | [ 'Phys/X2KPiBeauty2Charm' ]        |
| DecayDescriptor | None                                  |
| Output          | Phys/K\*0Beauty2CharmFilter/Particles |

FilterDesktop/Kstar02KPiPIDBeauty2CharmFilter

|                 |                                                                                                                                                                         |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Code            | (NINGENERATION(('p+'==ABSID) & (PIDp \< -10),1) == 0) & (NINGENERATION(('K+'==ABSID) & (PIDK \< -10), 1) == 0) & (NINGENERATION(('pi+'==ABSID) & (PIDK \> 20), 1) == 0) |
| Inputs          | [ 'Phys/K\*0Beauty2CharmFilter' ]                                                                                                                                     |
| DecayDescriptor | None                                                                                                                                                                    |
| Output          | Phys/Kstar02KPiPIDBeauty2CharmFilter/Particles                                                                                                                          |

CombineParticles/B2DKstar0D2HHHPIDBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                          |
|------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2HHHPIDBeauty2CharmFilter' , 'Phys/Kstar02KPiPIDBeauty2CharmFilter' ]                                                                                                                                                                                                                                                                                                                         |
...
| Output           | Phys/B2DKstar0D2HHHPIDBeauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                                             |

TisTosParticleTagger/B2DKstar0D2HHHPIDBeauty2CharmTISTOS

|                 |                                                                                                                                       |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B2DKstar0D2HHHPIDBeauty2Charm' ]                                                                                            |
| DecayDescriptor | None                                                                                                                                  |
| Output          | Phys/B2DKstar0D2HHHPIDBeauty2CharmTISTOS/Particles                                                                                    |
| TisTosSpecs     | { 'Hlt2IncPhi.\*Decision%TIS' : 0 , 'Hlt2IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                       |
|-----------------|-----------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                       |
| Inputs          | [ 'Phys/B2DKstar0D2HHHPIDBeauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                  |
| Output          | Phys/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

SubstitutePID/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPSel

|                 |                                                                                 |
|-----------------|---------------------------------------------------------------------------------|
| Code            | DECTREE('Beauty -\> Charm ...')                                                 |
| Inputs          | [ 'Phys/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilter' ]             |
| DecayDescriptor | None                                                                            |
| Output          | Phys/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPSel/Particles |
| Substitutions   | { 'Beauty -\> Charm ...' : 'J/psi(1S)' }                                        |

FilterDesktop/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPFilterBeauty2CharmFilter

|                 |                                                                                                      |
|-----------------|------------------------------------------------------------------------------------------------------|
| Code            | INTREE(ID=='J/psi(1S)')                                                                              |
| Inputs          | [ 'Phys/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPSel' ]                        |
| DecayDescriptor | None                                                                                                 |
| Output          | Phys/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPFilterBeauty2CharmFilter/Particles |

CombineParticles/DstarUPB2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilter

|                  |                                                                                                                                                               |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/B2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilterDstarUPFilterBeauty2CharmFilter' , 'Phys/PiUPInputsBeauty2CharmFilter' ]                      |
...
| Output           | Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles                                                                                  |

FilterDesktop/DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine

|                 |                                                                            |
|-----------------|----------------------------------------------------------------------------|
| Code            | ALL                                                                        |
| Inputs          | [ 'Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                       |
| Output          | Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine

|                 |                                                                      |
|-----------------|----------------------------------------------------------------------|
| Inputs          | [ 'Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                 |
| Output          | Phys/RelatedInfo1_DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine

|                 |                                                                      |
|-----------------|----------------------------------------------------------------------|
| Inputs          | [ 'Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                 |
| Output          | Phys/RelatedInfo2_DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine

|                 |                                                                      |
|-----------------|----------------------------------------------------------------------|
| Inputs          | [ 'Phys/DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                 |
| Output          | Phys/RelatedInfo3_DstarUPB2DKstar0D2HHHPIDBeauty2CharmLine/Particles |
