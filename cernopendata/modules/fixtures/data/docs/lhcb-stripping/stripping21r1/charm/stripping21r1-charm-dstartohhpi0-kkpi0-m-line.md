...
# StrippingDstarToHHPi0_KKpi0_M_Line

## Properties:

|                |                                                        |
|----------------|--------------------------------------------------------|
| OutputLocation | Phys/DstarToHHPi0_KKpi0_M_Line/Particles               |
| Postscale      | 1.0000000                                              |
...
LoKi::VoidFilter/StrippingDstarToHHPi0_KKpi0_M_LineVOIDFilter
...
CombineParticles/SelKstDstarToHHPi0_KKpi0_M\_
...
| Output           | Phys/SelKstDstarToHHPi0_KKpi0_M\_/Particles                                                                                                                                |
...
CombineParticles/SelD0DstarToHHPi0_KKpi0_M\_

|                  |                                                                             |
|------------------|-----------------------------------------------------------------------------|
| Inputs           | [ 'Phys/Pi0MForDstarToHHPi0' , 'Phys/SelKstDstarToHHPi0_KKpi0_M\_' ]      |
...
| Output           | Phys/SelD0DstarToHHPi0_KKpi0_M\_/Particles                                  |
...
CombineParticles/SelDstDstarToHHPi0_KKpi0_M\_

|                  |                                                                               |
|------------------|-------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/SelD0DstarToHHPi0_KKpi0_M\_' , 'Phys/SlowpionsForDstarToHHPi0' ]    |
| DaughtersCuts    | { '' : 'ALL' , 'D0' : 'ALL' , 'D~0' : 'ALL' , 'pi+' : 'ALL' , 'pi-' : 'ALL' } |
| CombinationCut   | (AM - ACHILD(M,1) \< 180+5 \*MeV) & (ADOCACHI2CUT(20,''))                     |
| MotherCut        | (M - CHILD(M,1) \< 180 \*MeV) & (VFASPF(VCHI2/VDOF) \< 9.0)                   |
| DecayDescriptor  | None                                                                          |
| DecayDescriptors | [ '[D\*(2010)+ -\> D0 pi+]cc' ]                                           |
| Output           | Phys/SelDstDstarToHHPi0_KKpi0_M\_/Particles                                   |

TisTosParticleTagger/DstarToHHPi0_KKpi0_M_Line

|                 |                                                 |
|-----------------|-------------------------------------------------|
| Inputs          | [ 'Phys/SelDstDstarToHHPi0_KKpi0_M\_' ]       |
| DecayDescriptor | None                                            |
| Output          | Phys/DstarToHHPi0_KKpi0_M_Line/Particles        |
