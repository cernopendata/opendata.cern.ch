...
# StrippingLowMultCEP_D2KmPipPip_D2KmPipPip_WS_line

## Properties:

|                |                                                         |
|----------------|---------------------------------------------------------|
| OutputLocation | Phys/LowMultCEP_D2KmPipPip_D2KmPipPip_WS_line/Particles |
| Postscale      | 1.0000000                                               |
...
**LoKi::VoidFilter/StrippingLowMultCEP_D2KmPipPip_D2KmPipPip_WS_lineVOIDFilter**
...
**CombineParticles/LowMultCEP_D2KmPipPip_D2KmPipPip_WS_line**
...
| Output           | Phys/LowMultCEP_D2KmPipPip_D2KmPipPip_WS_line/Particles |
