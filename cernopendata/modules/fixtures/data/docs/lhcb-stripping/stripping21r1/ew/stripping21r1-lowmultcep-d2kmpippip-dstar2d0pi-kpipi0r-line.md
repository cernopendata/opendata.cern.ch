...
|                |                                                              |
|----------------|--------------------------------------------------------------|
| OutputLocation | Phys/LowMultCEP_D2KmPipPip_Dstar2D0Pi_KPiPi0R_line/Particles |
| Postscale      | 1.0000000                                                    |
...
**LoKi::VoidFilter/StrippingLowMultCEP_D2KmPipPip_Dstar2D0Pi_KPiPi0R_lineVOIDFilter**
...
| Inputs          | [ 'Phys/ [StdLooseResolvedPi0](./stripping21r1-stdlooseresolvedpi0) ' ] |
| DecayDescriptor | None                                                                      |
...
**CombineParticles/LowMultCEP_D2KmPipPip_Dstar2D0Pi_KPiPi0R_line**

|                  |                                                                                            |
|------------------|--------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/selD2KmPipPip' , 'Phys/selDstar2D0Pi_KPiPi0R' ]                                  |
| DaughtersCuts    | { '' : 'ALL' , 'D\*(2010)+' : 'ALL' , 'D\*(2010)-' : 'ALL' , 'D+' : 'ALL' , 'D-' : 'ALL' } |
| CombinationCut   | AALL                                                                                       |
| MotherCut        | ALL                                                                                        |
| DecayDescriptor  | None                                                                                       |
| DecayDescriptors | [ '[psi(4040) -\> D+ D\*(2010)-]cc' , '[psi(4040) -\> D+ D\*(2010)+]cc' ]            |
| Output           | Phys/LowMultCEP_D2KmPipPip_Dstar2D0Pi_KPiPi0R_line/Particles                               |
