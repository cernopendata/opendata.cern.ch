...
|                |                                                               |
|----------------|---------------------------------------------------------------|
| OutputLocation | Phys/LowMultCEP_Dstar2D0Pi_KPi_Dstar2D0Pi_K3Pi_line/Particles |
| Postscale      | 1.0000000                                                     |
...
**LoKi::VoidFilter/StrippingLowMultCEP_Dstar2D0Pi_KPi_Dstar2D0Pi_K3Pi_lineVOIDFilter**
...
**CombineParticles/selDstar2D0Pi_K3Pi**
...
| DecayDescriptor  | None                                                                           |
| DecayDescriptors | [ '[D\*(2010)+ -\> D0 pi+]cc' , '[D\*(2010)+ -\> D\~0 pi+]cc' ]          |
| Output           | Phys/selDstar2D0Pi_K3Pi/Particles                                              |

**CombineParticles/LowMultCEP_Dstar2D0Pi_KPi_Dstar2D0Pi_K3Pi_line**

|                  |                                                                                           |
|------------------|-------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/selDstar2D0Pi_K3Pi' , 'Phys/selDstar2D0Pi_KPi' ]                                |
| DaughtersCuts    | { '' : 'ALL' , 'D\*(2010)+' : 'ALL' , 'D\*(2010)-' : 'ALL' }                              |
| CombinationCut   | AALL                                                                                      |
| MotherCut        | ALL                                                                                       |
| DecayDescriptor  | None                                                                                      |
| DecayDescriptors | [ 'psi(4040) -\> D\*(2010)+ D\*(2010)-' , '[psi(4040) -\> D\*(2010)+ D\*(2010)+]cc' ] |
| Output           | Phys/LowMultCEP_Dstar2D0Pi_KPi_Dstar2D0Pi_K3Pi_line/Particles                             |
