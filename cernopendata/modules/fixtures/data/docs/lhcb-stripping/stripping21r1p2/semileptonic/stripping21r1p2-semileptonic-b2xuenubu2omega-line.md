...
# StrippingB2XuENuBu2Omega_Line

## Properties:

|                |                                     |
|----------------|-------------------------------------|
| OutputLocation | Phys/B2XuENuBu2Omega_Line/Particles |
| Postscale      | 1.0000000                           |
| HLT1           | None                                |
| HLT2           | None                                |
| Prescale       | 1.0000000                           |
...
LoKi::VoidFilter/StrippingB2XuENuBu2Omega_LineVOIDFilter
...
CombineParticles/OmegaE_forB2XuENu
...
| Output           | Phys/OmegaE_forB2XuENu/Particles                                                                                               |

TisTosParticleTagger/B2XuENuBu2Omega_Line

|                 |                                                                                                                                     |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/OmegaE_forB2XuENu' ]                                                                                                      |
| DecayDescriptor | None                                                                                                                                |
| Output          | Phys/B2XuENuBu2Omega_Line/Particles                                                                                                 |
