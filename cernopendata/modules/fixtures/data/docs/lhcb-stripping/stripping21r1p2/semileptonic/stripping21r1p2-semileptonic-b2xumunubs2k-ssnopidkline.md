...
|                |                                          |
|----------------|------------------------------------------|
| OutputLocation | Phys/B2XuMuNuBs2K_SSNoPIDKLine/Particles |
| Postscale      | 1.0000000                                |
| HLT1           | None                                     |
| HLT2           | None                                     |
...
LoKi::VoidFilter/StrippingB2XuMuNuBs2K_SSNoPIDKLineVOIDFilter
...
TisTosParticleTagger/B2XuMuNuBs2K_SSNoPIDKLine

|                 |                                                                                      |
|-----------------|--------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/KMuSS_NoPIDK_forB2XuMuNu' ]                                                |
| DecayDescriptor | None                                                                                 |
| Output          | Phys/B2XuMuNuBs2K_SSNoPIDKLine/Particles                                             |
