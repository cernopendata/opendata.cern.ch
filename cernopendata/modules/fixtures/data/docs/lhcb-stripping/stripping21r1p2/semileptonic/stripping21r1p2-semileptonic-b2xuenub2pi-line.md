...
# StrippingB2XuENuB2Pi_Line

## Properties:

|                |                                 |
|----------------|---------------------------------|
| OutputLocation | Phys/B2XuENuB2Pi_Line/Particles |
| Postscale      | 1.0000000                       |
| HLT1           | None                            |
| HLT2           | None                            |
| Prescale       | 0.20000000                      |
...
LoKi::VoidFilter/StrippingB2XuENuB2Pi_LineVOIDFilter
...
CombineParticles/PiE_forB2XuENu
...
| Output           | Phys/PiE_forB2XuENu/Particles                                                                                                 |

TisTosParticleTagger/B2XuENuB2Pi_Line

|                 |                                                                                            |
|-----------------|--------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/PiE_forB2XuENu' ]                                                                |
| DecayDescriptor | None                                                                                       |
| Output          | Phys/B2XuENuB2Pi_Line/Particles                                                            |
