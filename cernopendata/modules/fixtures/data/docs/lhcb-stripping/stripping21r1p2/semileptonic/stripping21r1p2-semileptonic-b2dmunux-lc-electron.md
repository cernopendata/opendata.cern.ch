...
|                |                                     |
|----------------|-------------------------------------|
| OutputLocation | Phys/B2DMuNuX_Lc_Electron/Particles |
| Postscale      | 1.0000000                           |
...
LoKi::VoidFilter/StrippingB2DMuNuX_Lc_ElectronVOIDFilter
...
CombineParticles/CharmSelForLc_ElectronB2DMuNuX
...
| Output           | Phys/CharmSelForLc_ElectronB2DMuNuX/Particles                                                               |

CombineParticles/B2DMuNuX_Lc_Electron

|                  |                                                                                                                                                                                                                                      |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/CharmSelForLc_ElectronB2DMuNuX' , 'Phys/eforB2DMuNuX' ]                                                                                                                                                                    |
| DaughtersCuts    | { '' : 'ALL' , 'Lambda_c+' : 'ALL' , 'Lambda_c~-' : 'ALL' , 'e+' : 'ALL' , 'e-' : 'ALL' }                                                                                                                                            |
...
| DecayDescriptor  | None                                                                                                                                                                                                                                 |
| DecayDescriptors | [ '[Lambda_b0 -\> Lambda_c+ e-]cc' , '[Lambda_b0 -\> Lambda_c+ e+]cc' ]                                                                                                                                                        |
| Output           | Phys/B2DMuNuX_Lc_Electron/Particles                                                                                                                                                                                                  |
