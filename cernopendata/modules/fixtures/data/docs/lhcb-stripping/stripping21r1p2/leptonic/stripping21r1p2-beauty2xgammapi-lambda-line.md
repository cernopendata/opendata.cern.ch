...
|      |                                      |
|------|--------------------------------------|
| Code | 0 StdLooseLambdaLL /Particles',True) |
...
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                                                                     |
| Inputs          | [ 'Phys/ [StdLooseLambdaDD](./stripping21r1p2-stdlooselambdadd) ' , 'Phys/ [StdLooseLambdaLL](./stripping21r1p2-stdlooselambdall) ' ] |
...
| PreloadTools :                 | False                                                                                                     |
| ForceP2PVBuild :               | True                                                                                                      |
| OutputPlotsPath :              | OMergedLambdas                                                                                            |
| NeededResources :              | [ ]                                                                                                     |
| Context :                      | None                                                                                                      |
| OutputLevel :                  | 3                                                                                                         |
| ForceOutput :                  | True                                                                                                      |
...
**AddRelatedInfo/RelatedInfo1_Beauty2XGammapi_Lambda_Line**
...
**AddRelatedInfo/RelatedInfo7_Beauty2XGammapi_Lambda_Line**
