...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/B02DDBeauty2CharmLine/Particles                                            |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingB02DDBeauty2CharmLineVOIDFilter
...
FilterDesktop/D4B2DDBeauty2CharmFilter

|                 |                                              |
|-----------------|----------------------------------------------|
| Code            | (MM\>1789.62\*MeV) & (MM \< 2048.49\*MeV)    |
| Inputs          | [ 'Phys/D2HHHPIDTIGHTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                         |
| Output          | Phys/D4B2DDBeauty2CharmFilter/Particles      |

LoKi::VoidFilter/B02DDBeauty2CharmCombCutD4B2DDBeauty2CharmFilter

|      |                                                             |
|------|-------------------------------------------------------------|
| Code | (CONTAINS('Phys/D4B2DDBeauty2CharmFilter/Particles')\<2000) |

CombineParticles/B02DDBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D4B2DDBeauty2CharmFilter' ]                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| DaughtersCuts    | { '' : 'ALL' , 'D+' : 'ALL' , 'D-' : 'ALL' }                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| CombinationCut   | (ASUM(SUMTREE(PT,(ISBASIC \| (ID=='gamma')),0.0))\>5000\*MeV) & (AM\>4950\*MeV) & (AM\<6000\*MeV)                                                                                                                                                                                                                                                                                                                                                                                                            |
| MotherCut        | (VFASPF(VCHI2/VDOF)\<10) & (INTREE(HASTRACK & (P\>10000\*MeV) & (PT\>1700\*MeV) & (TRCHI2DOF\<4.) & (MIPCHI2DV(PRIMARY)\>16) & (MIPDV(PRIMARY)\>0.1\*mm))) & (NINTREE((ISBASIC & HASTRACK & (TRCHI2DOF\<4.) & (PT \> 500\*MeV) & (P \> 5000\*MeV))\|((ABSID=='KS0') & (PT \> 500\*MeV) & (P \> 5000\*MeV) & (BPVVDCHI2 \> 1000))) \> 1) & (BPVLTIME()\>0.2\*ps) & ( (CHILD(VFASPF(VZ), 1) - VFASPF(VZ))\>-1.5\*mm) & ( (CHILD(VFASPF(VZ), 2) - VFASPF(VZ))\>-1.5\*mm) & (BPVIPCHI2()\<25) & (BPVDIRA\>0.999) |
| DecayDescriptor  | None                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
FilterDesktop/B02DDBeauty2CharmLine
...
| DecayDescriptor | None                                                    |
| Output          | Phys/B02DDBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_B02DDBeauty2CharmLine

|                 |                                                   |
|-----------------|---------------------------------------------------|
| Inputs          | [ 'Phys/B02DDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                              |
| Output          | Phys/RelatedInfo1_B02DDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_B02DDBeauty2CharmLine

|                 |                                                   |
|-----------------|---------------------------------------------------|
| Inputs          | [ 'Phys/B02DDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                              |
| Output          | Phys/RelatedInfo2_B02DDBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_B02DDBeauty2CharmLine

|                 |                                                   |
|-----------------|---------------------------------------------------|
| Inputs          | [ 'Phys/B02DDBeauty2CharmLine' ]                |
| DecayDescriptor | None                                              |
| Output          | Phys/RelatedInfo3_B02DDBeauty2CharmLine/Particles |
