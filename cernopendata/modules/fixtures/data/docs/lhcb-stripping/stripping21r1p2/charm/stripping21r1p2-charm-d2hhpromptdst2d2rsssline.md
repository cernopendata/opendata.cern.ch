...
# StrippingD2hhPromptDst2D2RSSSLine

## Properties:

|                |                                         |
|----------------|-----------------------------------------|
| OutputLocation | Phys/D2hhPromptDst2D2RSSSLine/Particles |
| Postscale      | 1.0000000                               |
| HLT1           | None                                    |
| HLT2           | None                                    |
| Prescale       | 1.0000000                               |
...
CombineParticles/D2hhPromptD2KPiSSSel
...
| Output           | Phys/D2hhPromptD2KPiSSSel/Particles                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |

CombineParticles/D2hhPromptDst2D2RSSSLine

|                  |                                                                                                                     |
|------------------|---------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2hhPromptD2KPiSSSel' , 'Phys/[StdAllNoPIDsPions](./stripping21r1p2-commonparticles-stdallnopidspions)' ] |
...
| Output           | Phys/D2hhPromptDst2D2RSSSLine/Particles                                                                             |
