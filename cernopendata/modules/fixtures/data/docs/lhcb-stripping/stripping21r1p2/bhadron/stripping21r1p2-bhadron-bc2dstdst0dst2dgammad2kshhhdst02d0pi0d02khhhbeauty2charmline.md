...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine/Particles     |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingBc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLineVOIDFilter
...
LoKi::VoidFilter/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmCombCutBC2DD-Dst2DGammaD2KSHHH-Beauty2Charm
...
LoKi::VoidFilter/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmCombCutBC2DD-Dst02D0PI0D02KHHH-Beauty2Charm

|      |                                                                         |
|------|-------------------------------------------------------------------------|
| Code | (CONTAINS('Phys/BC2DD-Dst02D0PI0D02KHHH-Beauty2Charm/Particles')\<2000) |

CombineParticles/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                         |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/BC2DD-Dst02D0PI0D02KHHH-Beauty2Charm' , 'Phys/BC2DD-Dst2DGammaD2KSHHH-Beauty2Charm' ]                                                                                                                                                                                                                                                                                                         |
...
| Output           | Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                 |

TisTosParticleTagger/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmTISTOS

|                 |                                                                                                                                             |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2Charm' ]                                                                       |
| DecayDescriptor | None                                                                                                                                        |
| Output          | Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmTISTOS/Particles                                                               |
| TisTosSpecs     | { 'Hlt2.\*IncPhi.\*Decision%TIS' : 0 , 'Hlt2.\*IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                                                  |
|-----------------|--------------------------------------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                                                  |
| Inputs          | [ 'Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                                             |
| Output          | Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

FilterDesktop/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine

|                 |                                                                                                |
|-----------------|------------------------------------------------------------------------------------------------|
| Code            | ALL                                                                                            |
| Inputs          | [ 'Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                                           |
| Output          | Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine

|                 |                                                                                          |
|-----------------|------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                                     |
| Output          | Phys/RelatedInfo1_Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine

|                 |                                                                                          |
|-----------------|------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                                     |
| Output          | Phys/RelatedInfo2_Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine

|                 |                                                                                          |
|-----------------|------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                                     |
| Output          | Phys/RelatedInfo3_Bc2DstDst0Dst2DGammaD2KSHHHDst02D0PI0D02KHHHBeauty2CharmLine/Particles |
