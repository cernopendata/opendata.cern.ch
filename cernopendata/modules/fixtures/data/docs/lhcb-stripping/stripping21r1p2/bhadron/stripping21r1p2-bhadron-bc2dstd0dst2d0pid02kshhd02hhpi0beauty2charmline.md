...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine/Particles                  |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingBc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLineVOIDFilter
...
LoKi::VoidFilter/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmCombCutBC2DD-Dst2D0PID02KSHH-Beauty2Charm
...
LoKi::VoidFilter/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmCombCutBC2DD-D02HHPI0-Beauty2Charm

|      |                                                                |
|------|----------------------------------------------------------------|
| Code | (CONTAINS('Phys/BC2DD-D02HHPI0-Beauty2Charm/Particles')\<2000) |

CombineParticles/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                         |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/BC2DD-D02HHPI0-Beauty2Charm' , 'Phys/BC2DD-Dst2D0PID02KSHH-Beauty2Charm' ]                                                                                                                                                                                                                                                                                                                    |
...
| Output           | Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                              |

TisTosParticleTagger/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmTISTOS

|                 |                                                                                                                                             |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2Charm' ]                                                                                    |
| DecayDescriptor | None                                                                                                                                        |
| Output          | Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmTISTOS/Particles                                                                            |
| TisTosSpecs     | { 'Hlt2.\*IncPhi.\*Decision%TIS' : 0 , 'Hlt2.\*IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                                     |
|-----------------|-------------------------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                                     |
| Inputs          | [ 'Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                                |
| Output          | Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

FilterDesktop/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine

|                 |                                                                                   |
|-----------------|-----------------------------------------------------------------------------------|
| Code            | ALL                                                                               |
| Inputs          | [ 'Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                              |
| Output          | Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine

|                 |                                                                             |
|-----------------|-----------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine' ]                |
| DecayDescriptor | None                                                                        |
| Output          | Phys/RelatedInfo1_Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine

|                 |                                                                             |
|-----------------|-----------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine' ]                |
| DecayDescriptor | None                                                                        |
| Output          | Phys/RelatedInfo2_Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine

|                 |                                                                             |
|-----------------|-----------------------------------------------------------------------------|
| Inputs          | [ 'Phys/Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine' ]                |
| DecayDescriptor | None                                                                        |
| Output          | Phys/RelatedInfo3_Bc2DstD0Dst2D0PID02KSHHD02HHPI0Beauty2CharmLine/Particles |
