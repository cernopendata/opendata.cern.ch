...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/B2D0KD2KSMuMuLLWSBeauty2CharmLine/Particles                                |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingB2D0KD2KSMuMuLLWSBeauty2CharmLineVOIDFilter
...
LoKi::VoidFilter/B2D0KD2KSMuMuLLWSBeauty2CharmCombCutD2KsMuMuWSBeauty2Charm_LL
...
LoKi::VoidFilter/B2D0KD2KSMuMuLLWSBeauty2CharmCombCutKTopoInputsBeauty2CharmFilter

|      |                                                                  |
|------|------------------------------------------------------------------|
| Code | (CONTAINS('Phys/KTopoInputsBeauty2CharmFilter/Particles')\<2000) |

CombineParticles/B2D0KD2KSMuMuLLWSBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                        |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/D2KsMuMuWSBeauty2Charm_LL' , 'Phys/KTopoInputsBeauty2CharmFilter' ]                                                                                                                                                                                                                                                                                                                          |
...
| Output           | Phys/B2D0KD2KSMuMuLLWSBeauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                                           |

TisTosParticleTagger/B2D0KD2KSMuMuLLWSBeauty2CharmTISTOS

|                 |                                                                                                                                             |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B2D0KD2KSMuMuLLWSBeauty2Charm' ]                                                                                                  |
| DecayDescriptor | None                                                                                                                                        |
| Output          | Phys/B2D0KD2KSMuMuLLWSBeauty2CharmTISTOS/Particles                                                                                          |
| TisTosSpecs     | { 'Hlt2.\*IncPhi.\*Decision%TIS' : 0 , 'Hlt2.\*IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/B2D0KD2KSMuMuLLWSBeauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                       |
|-----------------|-----------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                       |
| Inputs          | [ 'Phys/B2D0KD2KSMuMuLLWSBeauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                  |
| Output          | Phys/B2D0KD2KSMuMuLLWSBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

FilterDesktop/B2D0KD2KSMuMuLLWSBeauty2CharmLine

|                 |                                                                     |
|-----------------|---------------------------------------------------------------------|
| Code            | ALL                                                                 |
| Inputs          | [ 'Phys/B2D0KD2KSMuMuLLWSBeauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                |
| Output          | Phys/B2D0KD2KSMuMuLLWSBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_B2D0KD2KSMuMuLLWSBeauty2CharmLine

|                 |                                                               |
|-----------------|---------------------------------------------------------------|
| Inputs          | [ 'Phys/B2D0KD2KSMuMuLLWSBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                          |
| Output          | Phys/RelatedInfo1_B2D0KD2KSMuMuLLWSBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_B2D0KD2KSMuMuLLWSBeauty2CharmLine

|                 |                                                               |
|-----------------|---------------------------------------------------------------|
| Inputs          | [ 'Phys/B2D0KD2KSMuMuLLWSBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                          |
| Output          | Phys/RelatedInfo2_B2D0KD2KSMuMuLLWSBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_B2D0KD2KSMuMuLLWSBeauty2CharmLine

|                 |                                                               |
|-----------------|---------------------------------------------------------------|
| Inputs          | [ 'Phys/B2D0KD2KSMuMuLLWSBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                          |
| Output          | Phys/RelatedInfo3_B2D0KD2KSMuMuLLWSBeauty2CharmLine/Particles |
