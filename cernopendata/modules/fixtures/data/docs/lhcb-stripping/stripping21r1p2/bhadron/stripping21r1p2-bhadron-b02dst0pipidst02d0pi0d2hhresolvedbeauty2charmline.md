...
|                |                                                                                 |
|----------------|---------------------------------------------------------------------------------|
| OutputLocation | Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine/Particles                |
| Postscale      | 1.0000000                                                                       |
| HLT1           | None                                                                            |
...
LoKi::VoidFilter/StrippingB02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLineVOIDFilter
...
LoKi::VoidFilter/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmCombCutDstar02D0D2HHPIDPi0ResolvedBeauty2Charm
...
LoKi::VoidFilter/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmCombCutX2PiPiBeauty2Charm

|      |                                                       |
|------|-------------------------------------------------------|
| Code | (CONTAINS('Phys/X2PiPiBeauty2Charm/Particles')\<2000) |

CombineParticles/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2Charm

|                  |                                                                                                                                                                                                                                                                                                                                                                                                         |
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs           | [ 'Phys/Dstar02D0D2HHPIDPi0ResolvedBeauty2Charm' , 'Phys/X2PiPiBeauty2Charm' ]                                                                                                                                                                                                                                                                                                                        |
| DaughtersCuts    | { '' : 'ALL' , 'D\*(2007)0' : 'ALL' , 'D\*(2007)~0' : 'ALL' , 'rho(770)0' : 'ALL' }                                                                                                                                                                                                                                                                                                                     |
| CombinationCut   | (ASUM(SUMTREE(PT,(ISBASIC \| (ID=='gamma')),0.0))\>5000\*MeV) & (AM\<6000\*MeV) & (AM\>5000\*MeV)                                                                                                                                                                                                                                                                                                       |
| MotherCut        | (VFASPF(VCHI2/VDOF)\<10) & (INTREE(HASTRACK & (P\>10000\*MeV) & (PT\>1700\*MeV) & (TRCHI2DOF\<4.) & (MIPCHI2DV(PRIMARY)\>16) & (MIPDV(PRIMARY)\>0.1\*mm))) & (NINTREE((ISBASIC & HASTRACK & (TRCHI2DOF\<4.) & (PT \> 500\*MeV) & (P \> 5000\*MeV))\|((ABSID=='KS0') & (PT \> 500\*MeV) & (P \> 5000\*MeV) & (BPVVDCHI2 \> 1000))) \> 1) & (BPVLTIME()\>0.2\*ps) & (BPVIPCHI2()\<9) & (BPVDIRA\>0.99995) |
| DecayDescriptor  | None                                                                                                                                                                                                                                                                                                                                                                                                    |
| DecayDescriptors | [ 'B0 -\> D\*(2007)0 rho(770)0' ]                                                                                                                                                                                                                                                                                                                                                                     |
| Output           | Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2Charm/Particles                                                                                                                                                                                                                                                                                                                                            |

TisTosParticleTagger/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmTISTOS

|                 |                                                                                                                                             |
|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2Charm' ]                                                                                  |
| DecayDescriptor | None                                                                                                                                        |
| Output          | Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmTISTOS/Particles                                                                          |
| TisTosSpecs     | { 'Hlt2.\*IncPhi.\*Decision%TIS' : 0 , 'Hlt2.\*IncPhi.\*Decision%TOS' : 0 , 'Hlt2Topo.\*Decision%TIS' : 0 , 'Hlt2Topo.\*Decision%TOS' : 0 } |

FilterDesktop/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmB2CBBDTBeauty2CharmFilter

|                 |                                                                                       |
|-----------------|---------------------------------------------------------------------------------------|
| Code            | FILTER('BBDecTreeTool/B2CBBDT')                                                       |
| Inputs          | [ 'Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmTISTOS' ]                      |
| DecayDescriptor | None                                                                                  |
| Output          | Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmB2CBBDTBeauty2CharmFilter/Particles |

FilterDesktop/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine

|                 |                                                                                     |
|-----------------|-------------------------------------------------------------------------------------|
| Code            | ALL                                                                                 |
| Inputs          | [ 'Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmB2CBBDTBeauty2CharmFilter' ] |
| DecayDescriptor | None                                                                                |
| Output          | Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine/Particles                    |

AddRelatedInfo/RelatedInfo1_B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine

|                 |                                                                               |
|-----------------|-------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                          |
| Output          | Phys/RelatedInfo1_B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo2_B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine

|                 |                                                                               |
|-----------------|-------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                          |
| Output          | Phys/RelatedInfo2_B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine/Particles |

AddRelatedInfo/RelatedInfo3_B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine

|                 |                                                                               |
|-----------------|-------------------------------------------------------------------------------|
| Inputs          | [ 'Phys/B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine' ]                |
| DecayDescriptor | None                                                                          |
| Output          | Phys/RelatedInfo3_B02Dst0PiPiDst02D0Pi0D2HHResolvedBeauty2CharmLine/Particles |
