...
class RecordSchemaorgSchema(Schema):
    ...
    date_created = fields.Str(attribute='date_published',
                              dump_to='dateCreated')
    ...
    def get_creator(self, obj):
        ...
        if authors:
            ...
            collaboration = obj.get('collaboration', None).get('name', None)
            if collaboration:
    ...
    def get_identifier(self, obj):
        ...
        if doi:
            ...
            return "http://opendata.cern.ch/record/{}".format(recid)
...
class DocumentationSchemaorgSchema(RecordSchemaorgSchema):
    ...
    def get_url(self, obj):
        ...
        return "http://opendata.cern.ch/docs/{}".format(slug)
