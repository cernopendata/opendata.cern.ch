...
void mergeMinBias() {
  ...
  Target = TFile::Open( "MinBiasAllval.root", "RECREATE" );
...
FileList->Add( TFile::Open("MinBias00val.root"));
FileList->Add( TFile::Open("MinBias01val.root"));
FileList->Add( TFile::Open("MinBias02val.root"));
FileList->Add( TFile::Open("MinBias03val.root"));
FileList->Add( TFile::Open("MinBias04val.root"));
FileList->Add( TFile::Open("MinBias05val.root"));
FileList->Add( TFile::Open("MinBias06val.root"));

//   // List of Cross-sections divided by num of events produced
  // --------------------------------------------------------
 //  double crossSections[8] = { 0.74,1,1,1,0.5,0.37,0.37,0.37};

 double crossSections[7] = { 1,1,1,1,1,1,1};
