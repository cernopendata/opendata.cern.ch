...
void mergeCommissioning() {
   // in an interactive ROOT session, edit the file names
   // Target and FileList, then
   // root > .L hadd.C
   // root > hadd()

  Target = TFile::Open( "CommissioningAllval.root", "RECREATE" );
...
FileList->Add( TFile::Open("Commissioning00val.root"));
FileList->Add( TFile::Open("Commissioning02val.root"));
FileList->Add( TFile::Open("Commissioning03val.root"));
FileList->Add( TFile::Open("Commissioning04val.root"));

//   // List of Cross-sections divided by num of events produced
  // --------------------------------------------------------
 //  double crossSections[8] = { 0.74,1,1,1,0.5,0.37,0.37,0.37};

 double crossSections[4] = { 1,1,1,1};
