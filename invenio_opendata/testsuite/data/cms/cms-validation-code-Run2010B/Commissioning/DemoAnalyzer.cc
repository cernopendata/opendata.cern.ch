...
//                                     ... not empty for Commissioning!
// If it is not empty, check JSON preselction in Python part of program
h201 = fs->make<TH1D>("Run number, no JSON","Run number, no JSON", 3100, 146400, 149500);
...
//       whether this was done and worked properly.
//       histogram h201 should normally be empty, but for this special 
//       Commissioning test it should get filled  
