# /cdaq/physics/Run2011HI/2760GeV/v1.1/HLT/V1 (CMSSW_3_11_0_HLT18)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string( '/cdaq/physics/Run2011HI/2760GeV/v1.1/HLT/V1' )
)
...
process.PrescaleService = cms.Service( "PrescaleService",
  ...
  prescaleTable = cms.VPSet(
    ...
    cms.PSet(
      ...
      prescales = cms.vuint32( 100, 50, 25, 10, 5 )
    ),
    cms.PSet(
    ...
    cms.PSet(
      ...
      prescales = cms.vuint32( 12, 4, 2, 1, 1 )
    ),
    cms.PSet(
    ...
    cms.PSet(
      ...
      prescales = cms.vuint32( 100, 50, 20, 10, 5 )
    ),
    cms.PSet(
