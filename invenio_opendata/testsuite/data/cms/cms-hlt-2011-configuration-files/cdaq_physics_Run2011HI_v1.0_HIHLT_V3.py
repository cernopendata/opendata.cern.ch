# /cdaq/physics/Run2011HI/v1.0/HIHLT/V3 (CMSSW_4_4_0_HLT12)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string( '/cdaq/physics/Run2011HI/v1.0/HIHLT/V3' )
)
...
process.PrescaleService = cms.Service( "PrescaleService",
  ...
  prescaleTable = cms.VPSet(
    ...
    cms.PSet(
      pathName = cms.string( "HLT_HISinglePhoton20_v1" ),
      prescales = cms.vuint32( 10, 7, 5, 3, 2, 1, 1, 1, 1, 1 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_HISinglePhoton30_v1" ),
    ...
    cms.PSet(
      pathName = cms.string( "HLT_HIUCC015_v1" ),
      prescales = cms.vuint32( 5, 4, 3, 2, 1, 1, 1, 1, 1, 1 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_HICentral10_v1" ),
...
process.hltGlobalSumETHfFilter4050 = cms.HLTFilter( "HLTGlobalSumsCaloMET",
  inputTag = cms.InputTag( "hltMetForHf" ),
  saveTags = cms.bool( False ),
  observable = cms.string( "sumEt" ),
...
process.hltGlobalSumETHfFilter4100 = cms.HLTFilter( "HLTGlobalSumsCaloMET",
  inputTag = cms.InputTag( "hltMetForHf" ),
  saveTags = cms.bool( False ),
  observable = cms.string( "sumEt" ),
...
process.hltL1sL1SingleEG8BptxAND = cms.HLTFilter( "HLTLevel1GTSeed",
  L1UseL1TriggerObjectMaps = cms.bool( True ),
  L1NrBxInEvent = cms.int32( 3 ),
  L1TechTriggerSeeding = cms.bool( False ),
  L1UseAliasesForSeeding = cms.bool( True ),
