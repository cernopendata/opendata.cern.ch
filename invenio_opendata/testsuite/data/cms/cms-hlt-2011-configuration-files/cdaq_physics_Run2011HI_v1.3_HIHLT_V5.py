# /cdaq/physics/Run2011HI/v1.3/HIHLT/V5 (CMSSW_4_4_0_HLT12)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string( '/cdaq/physics/Run2011HI/v1.3/HIHLT/V5' )
)
...
process.PrescaleService = cms.Service( "PrescaleService",
  ...
  prescaleTable = cms.VPSet(
    ...
    cms.PSet(
      ...
      prescales = cms.vuint32( 15, 12, 10, 5, 2, 1, 1, 1, 7, 3 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_HIL2Mu7_v2" ),
      prescales = cms.vuint32( 7, 6, 5, 1, 1, 1, 1, 1, 3, 3 )
    ),
    cms.PSet(
